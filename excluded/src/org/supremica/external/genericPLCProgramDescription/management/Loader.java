...
public class Loader
{
    ...
    public Object loadPLCProject(String path, String fileName)
    throws JAXBException, SAXException
    {
        // Create JAXBContext and unmarshaller for genericPLCProgramDescription
        try
        {
            jaxbContext = JAXBContext.newInstance("org.supremica.external.genericPLCProgramDescription.xsd");
            ...
            StreamSource ss = new StreamSource(new File("../schema/iec61131/xsd/TC6_XML_V10.xsd"));
