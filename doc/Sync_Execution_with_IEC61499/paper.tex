...
of the plant and disabling the controllable events of the
...
\begin{figure}[b]
  ...
  \caption{The model of the supervisor that make shure that
...
\begin{figure}
  \centering
  \includegraphics[scale=0.65]{figures/basic_block}
...
is \texttt{OCCURRED}. It signals that an discrete event has
...
\begin{figure}
  \centering
  \includegraphics[scale=0.45]{figures/P1}\\(a)
  \vskip 5mm
  \includegraphics[scale=0.45]{figures/P2}\\(b)
  \vskip 5mm
  \includegraphics[scale=0.45]{figures/Sp}\\(c)
...
\begin{figure}
  \centering
  \includegraphics[scale=0.45]{figures/sync_ecc}
