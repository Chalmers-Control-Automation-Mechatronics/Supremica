...
% Automation Object:
%    * consists of model, views, contorllers and configuration of those
%        * views and controllers operate on model 
%        * model has several interchangable implementations
%    * is extensible with user defined services
%    * supports replacement of services defined within the
%      object by user defind services
...
%    * has a access protection mechanism
