    ...
    implements PCGNode
{
	...
	case TYPE_SPEC:       return "spec";
	case TYPE_PLANT:      return "plant";
    ...
    public int getStatesSize() { return stateSet.getSize() ; }
    public int getEventsSize() { return eventSet.getSize() ; }
    public int getArcsSize() { return arcSet.getSize() ; }

    public StateSet getStates() { return stateSet; }
    public EventSet getEvents() { return eventSet; }
    public ArcSet   getArcs() { return arcSet; }
