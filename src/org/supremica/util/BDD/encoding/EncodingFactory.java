...
public class EncodingFactory
{
	public static Encoding getEncoder()
	{
		...
		case Options.ENCODING_DEFAULT :
			return new DefaultEncoding();

		case Options.ENCODING_RANDOM :
			return new RandomEncoding();

		case Options.ENCODING_DFS_I :
			return new DFSEncoding(true);

		case Options.ENCODING_DFS_M :
			return new DFSEncoding(false);

		case Options.ENCODING_BFS_I :
			return new BFSEncoding(true);

		case Options.ENCODING_BFS_M :
			return new BFSEncoding(false);
