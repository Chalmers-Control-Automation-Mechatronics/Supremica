...
class XMLReader extends DefaultHandler {
    ...
    private boolean getBooleanValue(Attributes attr, String query,
				    boolean def) {
	...
	if(qName.equals(TYPE_AUTOMATON)) {	    
	    ...
	    if(name == null) name = name_id;
	    else if(name_id == null) name_id = name; // just for fun :)
