...
class JBDD {
	...
	DEFAULT_NODE_COUNT = 2; // in million nodes
 ...
 // garbage collections
	...
	public static void main( String [] args) {
		...
		System.out.print("E v1. v1 & v2 = ");	jbdd.printSet(f);
		System.out.print("A v2. v1 & v2 = ");	jbdd.printSet(g);
		...
		System.out.print("S -> S' : v1 & v2 = ");	jbdd.printSet(rep);
