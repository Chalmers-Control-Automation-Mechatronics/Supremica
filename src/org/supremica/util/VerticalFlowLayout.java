 ...
 * @author Lee Lowry
 */
public class VerticalFlowLayout implements LayoutManager2, java.io.Serializable
{
   //----------------------------------
   // Alignment Values
   //----------------------------------
   ...
   public Dimension preferredLayoutSize(Container parent)
   {
      ...
      if (m_preferredSize == null || m_bDirty)
      {
         ...
         if (enum != null)
         {
            ...
            m_preferredSize = new Dimension( m_widestWidth + m_externalPadLeft +
                                             m_externalPadRight + (m_internalPadX*2),
