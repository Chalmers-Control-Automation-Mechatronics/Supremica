...
public class FunctionBlockBuilder extends ProgramAndFBBuilder {
    ...
    public FunctionBlockBuilder(String functionBlockName){
        ...
        mgRunArgs =new MethodGen(Constants.ACC_PUBLIC, Type.VOID, Type.NO_ARGS,
			      null, "runArgs",className,ilRunArgs,constPoolGen);
