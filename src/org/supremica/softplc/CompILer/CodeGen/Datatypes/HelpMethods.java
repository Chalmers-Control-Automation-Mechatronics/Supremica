...
public class HelpMethods{
    ...
    public static TypeANY_NUM parseANY_NUM(String s){
        ...
        case 1:
            if (st1.indexOf(".") != -1)
                {return null;}//new TypeREAL(removeDashes(st1));}
            else {return null;}//new TypeINT(removeDashes(st1),10);}

        case 2:
            if (st1.equals("2"))
                {return null;}//new TypeINT(removeDashes(tokens.nextToken()),2);}
            else if (st1.equals("8"))
                {return null;}//new TypeINT(removeDashes(tokens.nextToken()),8);}
            else if (st1.equals("16"))
                {return null;}//new TypeINT(removeDashes(tokens.nextToken()),16);}
            else if (st1.equals("SINT"))
                {return null;}//new TypeSINT(removeDashes(tokens.nextToken()),10);}
            else if (st1.equals("INT"))
                {return null;}//new TypeINT(removeDashes(tokens.nextToken()),10);}
            else if (st1.equals("DINT"))
                {return new TypeDINT (removeDashes(tokens.nextToken()),10);}
            else if (st1.equals("LINT"))
                {return null;}//new TypeLINT (removeDashes(tokens.nextToken()),10);}
            else if (st1.equals("USINT"))
                {return null;}//new TypeUSINT(removeDashes(tokens.nextToken()),10);}
            else if (st1.equals("UINT"))
                {return null;}//new TypeUINT(removeDashes(tokens.nextToken()),10);}
            else if (st1.equals("UDINT"))
                {return null;}//new TypeUDINT(removeDashes(tokens.nextToken()),10);}
            else if (st1.equals("ULINT"))
                {return null;}//new TypeULINT(removeDashes(tokens.nextToken()),10);}
            else if (st1.equals("REAL"))
                {return new TypeREAL(removeDashes(tokens.nextToken()));}
            else if (st1.equals("LREAL"))
                {return null;}//new TypeLREAL(removeDashes(tokens.nextToken()));}
        case 3:
            int radix = Integer.parseInt(tokens.nextToken());
            if (st1.equals("SINT"))
                {return null;}//new TypeSINT(removeDashes(tokens.nextToken()),radix);}
            else if (st1.equals("INT"))
                {return null;}//new TypeINT(removeDashes(tokens.nextToken()),radix);}
            else if (st1.equals("DINT"))
                {return new TypeDINT (removeDashes(tokens.nextToken()),radix);}
            else if (st1.equals("LINT"))
                {return null;}//new TypeLINT (removeDashes(tokens.nextToken()),radix);}
            else if (st1.equals("USINT"))
                {return null;}//new TypeUSINT(removeDashes(tokens.nextToken()),radix);}
            else if (st1.equals("UINT"))
                {return null;}//new TypeUINT(removeDashes(tokens.nextToken()),radix);}
            else if (st1.equals("UDINT"))
                {return null;}//new TypeUDINT(removeDashes(tokens.nextToken()),radix);}
            else if (st1.equals("ULINT"))
                {return null;}//new TypeULINT(removeDashes(tokens.nextToken()),radix);}
        }
