...
public class IlExprOperator
{
	...
	// ÄR DESSA LIKA??????????????????????????????
	OR = new IlExprOperator("OR("), XOR = new IlExprOperator("XOR("),
	ANDN = new IlExprOperator("ANDN("),    // operators "ANDN(" and "&N("
	ORN = new IlExprOperator("ORN("), XORN = new IlExprOperator("XORN("),
	ADD = new IlExprOperator("ADD("), SUB = new IlExprOperator("SUB("),
	MUL = new IlExprOperator("MUL("), DIV = new IlExprOperator("DIV("),
	MOD = new IlExprOperator("MOD("), GT = new IlExprOperator("GT("),
	GE = new IlExprOperator("GE("), EQ = new IlExprOperator("EQ("),
	LT = new IlExprOperator("LT("), LE = new IlExprOperator("LE("),
