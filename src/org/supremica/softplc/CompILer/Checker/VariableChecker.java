 ...
 */
		...
		{
			if (!(symbolicVariables.containsKey(v.name) || locatedVariables.containsKey(v.name)))
			{
				success = false;
 ...
 */
		...
		{
			if (!(symbolicVariables.containsKey(fbVariableName) || locatedVariables.containsKey(fbVariableName)))
			{
				success = false;
