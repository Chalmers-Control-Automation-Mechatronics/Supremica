	...
	public String toString() {
		if (directVariable)
			...
			if (fieldSelector != null) {
				return "variable: symbolic_variable " + name + "." +
					fieldSelector + " type: "+typeName+" fieldtype: " +
					fieldSelectorTypeName + " isFB: " + isFunctionBlock;
			} else {
				return "variable: symbolic_variable " + name + " type: " +
					typeName;
			}
	}
