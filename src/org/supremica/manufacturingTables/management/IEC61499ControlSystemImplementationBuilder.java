...
// 	    }
	...
	Device fuberDevice = new Device("DemoDevice", "App.sys", ".." + File.separatorChar + ".." + File.separatorChar + "Fuber" + File.separatorChar + "fblib", "demo" + File.pathSeparatorChar + "event" + File.pathSeparatorChar + "service", 1, coordinator, machineCoordinators, zones, cellMachines);
	fuberDevice.run();
    }
