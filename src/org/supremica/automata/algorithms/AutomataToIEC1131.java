	...
	//implements AutomataSerializer
{
	...
	{
		printILComment(pw, "(* This file is automatically generated from Supremica *)");
		printILComment(pw, "(* Supremica version: " + org.supremica.Version.version() + " *)");
		printILComment(pw, "(* This file was generated at: " +  DateFormat.getDateTimeInstance().format(new Date()) + " *)");
		printILComment(pw, "(* Synchronization type: " + syncType.toString() + "*)");
		printILComment(pw, "(* The following automata are synchronized: *)");
