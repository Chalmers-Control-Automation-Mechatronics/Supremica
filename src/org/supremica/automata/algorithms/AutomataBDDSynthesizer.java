...
public class AutomataBDDSynthesizer
{
	...
	public void cleanup()
	{
		if (supervisor != null) supervisor.cleanup();
		if (bddAutomata != null) bddAutomata.cleanup();
	}
                
    public int UCStates()
    {
        return supervisor.getUncontrollableStates();
    }
    
    public int coReachStates()
    {
        return supervisor.getCoReachables();
    }
    
    public int reachStates()
    {
        return supervisor.getReachables();
    }
    
    public int deadStates()
    {
        return supervisor.getDeadlocks();
    }
	...
	{
            return supervisor.getSafeStates(doNonBlocking, doControllable);
	}
	...
	public void generateCode()
	{
		...
		if (returnVal == JFileChooser.APPROVE_OPTION)
		{
			try
			{
				...
				Vector<DisablingPoint> all_bad = supervisor.getUnsafeTransitionTree(safe);
