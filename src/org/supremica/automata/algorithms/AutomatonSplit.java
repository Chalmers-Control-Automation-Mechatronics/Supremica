...
public class AutomatonSplit
{
	 ...
	 * having the same behaviour as the original when synchronized with its 'parents'.
		...
		throws Exception
	{
		...
		result = minimizer.getMinimizedAutomaton(MinimizationOptions.getDefaultMinimizationOptions());
