...
public class QMCUtilFormateo
{
    ...
    public static Object[][] generaDatosTablaVerdad(final int numVariables, final char forma, final String[] terminos, final String[] indiferencias)
    {
        ...
        // Introduce los t�rminos especificados en la tabla
        if(terminos!=null)
        {
     ...
     * @return cabecera
     */
    public static String[] generaCabeceraTablaVerdad(final String [] variables)
    {
        String []cabecera;
                                                           ...
                                                           final boolean minimizacionAuto)
    {
        ...
        final Object [][] matrizTerminosOrdenados = new Object [terminos.size()][3];
        terminoAnt = null;
      ...
      (final ArrayList<QMCBinarioBean> adyacencias, final boolean minimizacionAuto)
    {
        ...
        final Object [][] matrizAdyacencias = new Object [adyacencias.size()][4];
        adyacenciaAnt = null;
    ...
    /**
     * M�todo que convierte un array de elementos String en una cadena
     * @param array
     * @return cadena
     */
    public static String convierteArray2cadena(final String array[])
    {
        String cadena = "";
        ...
        if (listaTerminos.size()!=0)
        {
            ...
            for (int i=0; i<listaTerminos.size();i++)
            {
                ...
                for(int j=0; j<variables.length; j++)
                {
                    ...
                    if(binarioVar!='-')
                    {
                        // A�ado la variable al termino algebraico
                ...
                // A�ade el termino algebraico a la expresion algebraica
