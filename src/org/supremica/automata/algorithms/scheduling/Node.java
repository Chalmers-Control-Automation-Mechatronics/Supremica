...
public class Node {
	...
	public State getCorrespondingState() { return theState; }
	
	public Node getParent() { return theParent; }
	
	public boolean isAccepting() { return theState.isAccepting(); }
	
	public String getId() { return theState.getId(); }
}
