...
public abstract class Scheduler {
    protected static Logger logger = LoggerFactory.createLogger(Scheduler.class);
...
// 	init(false);
    ...
    public Scheduler(Automata theAutomata) throws Exception  {
	this(theAutomata, "1-product relax");
    }

    public Scheduler(Automata theAutomata, String heuristic) throws Exception {
