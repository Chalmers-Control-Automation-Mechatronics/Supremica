...
public class BDDPartitionVarOrdSorter {
    ...
    public BDDPartitionVarOrdSorter(final ExtendedAutomata originAutomata, final List<Object> variableOrdering,
    ...
    public void sort() {
        ...
        final BDDPartitionVarOrdAdapter algo = new BDDPartitionVarOrdAdapter(graph, false);
        algo.init();
