...
public abstract class BDDPartitionAlgoWorker {
     ...
     */
    public BDDPartitionAlgoWorker(final BDDPartitionSet partitions, final BDDPartitionCoordinator coordinator) {
    ...
    public BDD uncontrollableBackwardWorkSetAlgorithm(final BDD forbiddenStates) {
        ...
        final BDD uncontrollableTransitionRelationBDD = partitions.getUncontrollableTransitionRelationBDD();
