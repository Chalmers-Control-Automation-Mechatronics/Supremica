...
/**
 * A helper class as the second stage of heuristic selection. The same idea (even some implementation) is from Arash.
 *
 * @author   Zhennan
 * @version  2.0
 * @since    1.0
...
public class BDDPartitionHeuristicsLearner {
    ...
    public BDDPartitionHeuristicsLearner(int size) {
        max_activity = size;
