...
public class UncontrollableEventDepSets {
    ...
    private void initialize() {
        ...
        /* In this time, we don't have to care the variable updating. Just (1) for each uncontrollable event, 
            iterate each automaton where there is at least one edge labeled by this uncontrollable event. 
            (2) construct the BDD transition (3) BDD-OR with eventForwardPartialTransitions and put into 
            the map. That's all.  
         */
        uncontrollableEventIndexList.forEach(new TIntProcedure() {
