...
public interface BDDExDisjAlgorithms {
    ...
    /** Given a set of forbidden states (uncontrollable states or explicit forbidden states), the method is used to do the backward 
     *  reachability through any uncontrollable event to find more uncontrollable states which will append to the forbidden states
     */
