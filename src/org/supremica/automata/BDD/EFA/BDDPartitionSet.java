...
public abstract class BDDPartitionSet{
     ...
     */
    public BDDPartitionSet(BDDExtendedAutomata bddExAutomata) {
    ...
    /** 
     * Returns a map where the key is the component index while the value is the component transition in BDD 
     * 
     * @return a TTIntObjectHashMap object where the key is the component index and the value is the correspond BDD.
     */
    public abstract TIntObjectHashMap<BDD> getCompIndexToCompBDDMap();
    
    /**
     * Returns a map where the key is the component index and the value is an set of forward dependent component indices.
     */
    protected abstract TIntObjectHashMap<TIntHashSet> getForwardDependentComponentMap();

    /**
     * Returns a map where the key is the component index and the value is an set of backward dependent component indices.
     */
    protected abstract TIntObjectHashMap<TIntHashSet> getBackwardDependentComponentMap();
    
    /** 
     * Returns a set of component indices of which BDD partitions are qualified as the initial component candidates.
     */
    protected abstract TIntHashSet getInitialComponentCandidates();
    
    /** 
     * Returns a set of component indices of which BDD partitions are qualified as the marked component candidates. 
     */
    protected abstract TIntHashSet getMarkedComponentCandidates();

    /** 
     * Returns a BDD which represents all of the transitions labeled by uncontrollable events. 
     */
