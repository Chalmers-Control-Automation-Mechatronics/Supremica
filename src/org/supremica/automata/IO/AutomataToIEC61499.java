 ...
 * @author cengic
 *
 * This class generates an IEC 61499 function block implementing a bunch of automata.
 * The class is based on the AutomataToIEC1131 by KA.
 */
	...
	//implements AutomataSerializer
{
	...
	public AutomataToIEC61499(Project theProject, IEC61131Helper theHelper)
		throws Exception
	{
...
//						if (currAutomatonEvent == null)
//						{
//							throw new IllegalStateException("AutomataToIEC61499.printChangeTransitionsAsIL: " + "Could not find " + currEvent.getLabel() + " in automaton " + currAutomaton.getName());
//						}
//
...
//							if (toState == null)
//							{
//								throw new IllegalStateException("AutomataToIEC61499.printChangeTransitionsAsIL: " + "Could not find the next state from state " + currState.getName() + " with label " + currEvent.getLabel() + " in automaton " + currAutomaton.getName());
//							}
//							int toStateIndex = toState.getSynchIndex();
//							if (currState != toState)
//							{
