...
public class AutomataToNQC
{
	...
	public AutomataToNQC(final Automata theAutomata)
		throws Exception
	{
	...
	void printStateVariables(final PrintWriter pw)
		throws Exception
	{
		for (final Iterator<?> autIt = theAutomata.iterator(); autIt.hasNext(); )
		{
			...
			final int currStateIndex = indexMap.getStateIndex(currAutomaton, initialState);
	...
	private void printBooleanVariableDeclaration(final PrintWriter pw, final String variableName, final String comment, final String initvalue)
	{
	...
	void printBeginScanCycle(final PrintWriter pw)
	{
	...
	void printEndScanCycle(final PrintWriter pw)
	{
		pw.println("\t}");
	}
	...
	void printComputeExternalEnabledEvents(final PrintWriter pw)
		throws Exception
	{
	...
	void printInitializationFunction(final PrintWriter pw)
		throws Exception
	{
	...
	void printComputeExternalEnabledEventsFunctions(final PrintWriter pw)
		throws Exception
	{
	...
	void printDoEnabledEventsFunctions(final PrintWriter pw)
		throws Exception
	{
		pw.println("\n// Functions for the external enabled events");
		pw.println("// Note that all labels must valid identifiers in NQC");
	...
	void printComputeSingleEnabledEvent(final PrintWriter pw)
		throws Exception
	{
	 ...
	 * end_of_jumps:
	 */
	void printChangeStateTransitions(final PrintWriter pw)
		throws Exception
	{
			...
			for (final Iterator<?> autIt = theAutomata.iterator(); autIt.hasNext(); )
			{
				...
				if (currAlphabet.contains(currEvent.getLabel()))
				{
							...
							stateIt.hasNext(); )
					{
						...
						final int toStateIndex = indexMap.getStateIndex(currAutomaton, toState);
	...
	public void serializeNQC(final PrintWriter pw)
		throws Exception
	{
		initialize();
