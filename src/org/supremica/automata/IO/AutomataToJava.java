...
public class AutomataToJava
{
    ...
    void printFileHeader(PrintWriter pw)
    {
        ...
        for (Iterator it = project.inputSignalsIterator(); it.hasNext(); )
        {
        ...
        for (Iterator it = project.outputSignalsIterator(); it.hasNext(); )
        {
            Signal currSignal = (Signal) it.next();
        ...
        for (Iterator it = project.timerIterator(); it.hasNext(); )
        {
    ...
    private void printStartTimers(PrintWriter pw)
    {
        ...
        for (Iterator alphIt = allEvents.iterator(); alphIt.hasNext(); )
        {
            ...
            Iterator timerIt = project.getTimers().iteratorWithStartEvent(event);
