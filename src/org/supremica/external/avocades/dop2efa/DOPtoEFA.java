...
public class DOPtoEFA
	 ...
	 * @param block
	 */
	public static void createEFA(final ROP rop, final File f, final boolean block){
		//build module
		final Module module = buildModuleFromROP(rop);
	 ...
	 */
	public static Module buildModuleFromROP(final ROP rop){
	 ...
	 */
	public static Module buildModule(final List<String> filePathList, final String name, final boolean block){
		ROP rop = null;
	 ...
	 */
	public static Module buildModuleFromROP(final List<ROP> ropList, String moduleName, final boolean block){
	 ...
	 */
	public static Module buildModuleFromROP(final ROP rop, Module module){
		...
		final Properties startProp = factory.createProperties();
		final Properties stopProp = factory.createProperties();
	 ...
	 */
	public static ROP getROPfromFile(final File ropFile){
	 ...
	 *
	 */
	public static Relation collapseRelationTree( final Relation r ){
	 ...
	 */
	public static Relation addAttributeToActivities( final Relation relation, final Attribute att ){
		final List<Object> objList = relation.getActivityRelationGroup();
	 ...
	 * @param m
	 */
	public static void blockStopEventWithNoStartEvent(final Module m){

		final List<String> block = new LinkedList<String>();
		final List<String> events = m.getEvents();
		String tmp = "";
	 ...
	 */
	public static Relation removeEmtyRelations(final Relation relation){
	 ...
	 */
	private static Relation renameEqualOperationName(final Relation r, final String machineName){
	...
	private static Relation renameEqualOperationName(final Relation r,
													 final NumOfOperations operations,
	...
	private class NumOfOperations{
		...
		public int getNumberOfOperationsWithName(final String name){
			return operations.get(name);
		}

		public void addOperation(final String name){
			if(exist(name)){
