...
public class DOPnative {
	 ...
	 * @param efa
	 */
	protected static void nativeActivity(final Activity activity,
										 final String from,
										 final String to,
										 final EFA efa){
		...
		if(properties != null){
			final List<Attribute> attributeList = properties.getAttribute();
	 ...
	 */
	protected static void nativeSequence(final List<Activity> activityList,
		...
		final Iterator<Activity> i = activityList.iterator();
	...
	protected static void nativeAlternative(final List<Activity> activityList,
											String from, String to,
											final EFA efa){
		//chech indata
	 ...
	 * @param module
	 */
	protected static void addPrecondition(final Module module){
		...
		for(final Activity activity : activityPreconList){
			...
			if(preconList != null && preconList.size() != 0){
				...
				for(int i = 0; i < preconList.size(); i++){
					...
					final Object o =  preconList.get(i);
				...
				for(int i = 0; i < eventList.size(); i++){
					...
					final String event = eventList.get(i);
	 ...
	 */
	protected static String getEvent(final String event){
	 ...
	 */
	protected static String getMachine(final String event){
	...
	private static EGA bookResource(final EGA ega, final Module module, final Attribute att){

		final String resourceName = att.getAttributeValue();
	...
	private static EGA unBookResource(final EGA ega, final Module module, final Attribute att){
