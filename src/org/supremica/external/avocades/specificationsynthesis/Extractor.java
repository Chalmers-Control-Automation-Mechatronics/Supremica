...
public class Extractor
{
	...
	public class Restriction {
		...
		public List<ArrayList<String>> restrictions;
		...
		public Restriction(final String id, final String name, final ArrayList<ArrayList<String>> r)
		{
			opId = id;
			opName = name;
			restrictions = (List<ArrayList<String>>) r.clone();
		}
	}
...
* att fixa
*
* Kanske inte beh�ver ha operationens namn och id f�rst i varje entry i
* restrictions. D� m�ste vi �ndra i getStates, removeStates och remove-listan
* i simplifyOneOp.
*
******************************************************/
...
//System.out.println("hit0");
		...
		i++;
		simpleRestr.restrictions = (ArrayList<ArrayList<String>>) restrictions.clone();
	}
