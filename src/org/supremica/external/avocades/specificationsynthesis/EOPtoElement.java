                   ...
                   SpecificationSynthesXML
{
	 ...
	 *
	 */
	public static Element createElement( final EOP eop ){
			                             ...
			                             final String id)
	{
		...
		//add states
		//Actuator values
		for( final ActuatorValue actVal : initialState.getActuatorValue() ){
		...
		//Sensor values
		for(final SensorValue sensVal : initialState.getSensorValue()){
	 ...
	 */
	private static String removeMachineName(final String str){
	 ...
	 */
	private static Element createElement( final Action action){
