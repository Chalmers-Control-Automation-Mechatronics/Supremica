...
// Dispinterface _CommandBarButtonEvents Event Handler
public class _CommandBarButtonEventsHandlerImpl extends com.inzoom.comjni.JDispEventHandler {
  public static boolean dbg = false;
  public final org.supremica.external.comInterfaces.robotstudio_2_0.Office._CommandBarButtonEvents listener;
  public _CommandBarButtonEventsHandlerImpl(org.supremica.external.comInterfaces.robotstudio_2_0.Office._CommandBarButtonEvents listener){ this.listener = listener; }
  public int invoke(int dispid,int flags,int argPtr,int argCnt,int[] namedArgs,int retvalPtr,int[] argErr){
    ...
    switch(dispid) {
      case 1: {
        ...
        org.supremica.external.comInterfaces.robotstudio_2_0.Office.CommandBarButton arg0 = null;
        int argPos0 = -1;
        if(posArgCnt > 0){
          argPos0 = argCnt - 1;
        ...
        if(argPos0 >= 0){
          try {
            arg0 = org.supremica.external.comInterfaces.robotstudio_2_0.Office.CommandBarButton.convertComPtrToCommandBarButton(com.inzoom.comjni.Variant.jniGetUnknown(argPtr + argPos0 * com.inzoom.comjni.Variant.sizeof()),false);
