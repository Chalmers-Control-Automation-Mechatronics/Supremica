...
// Dispinterface DStationEvents Event Handler
public class DStationEventsHandlerImpl extends com.inzoom.comjni.JDispEventHandler {
  public static boolean dbg = false;
  public final org.supremica.external.comInterfaces.robotstudio_2_0.RobotStudio.DStationEvents listener;
  public DStationEventsHandlerImpl(org.supremica.external.comInterfaces.robotstudio_2_0.RobotStudio.DStationEvents listener){ this.listener = listener; }
  public int invoke(int dispid,int flags,int argPtr,int argCnt,int[] namedArgs,int retvalPtr,int[] argErr){
    ...
    switch(dispid) {
      ...
      case 2: {
        if(dbg) System.err.println("Event close called");
        try{
          listener.close();
        } catch(Exception e) {
          if(dbg) {System.err.print("Caught exception while handling event: "); e.printStackTrace(System.err);}
      ...
      case 3: {
        if(dbg) System.err.println("Event pick called");
        org.supremica.external.comInterfaces.robotstudio_2_0.RobotStudio.PickData arg0 = null;
        int argPos0 = -1;
        if(posArgCnt > 0){
          argPos0 = argCnt - 1;
        ...
        if(argPos0 >= 0){
          try {
            arg0 = org.supremica.external.comInterfaces.robotstudio_2_0.RobotStudio.PickData.convertComPtrToPickData(com.inzoom.comjni.Variant.jniGetUnknown(argPtr + argPos0 * com.inzoom.comjni.Variant.sizeof()),false);
