...
public class Plant
{
    ...
    private int[] nrOfStationsPerTable = { 0, 0, 0, 0, 0, 0, 5, 4, 3, 4, 1, 3,
    4 };
    ...
    public void createTable(int table_id, int table_type)
    {
        ...
        for (int i = 0; i < X + 1; i++)
        {
            filledOneState[i] = currTable.createUniqueState("q");
            currTable.addState(filledOneState[i]);
    ...
    public LabeledEvent[] createStation(int table_id, int station_id, Alphabet tableAlphabet)
    {
        ...
        State initialState = station.createUniqueState("q");
        station.addState(initialState);
        
        initialState.setInitial(true);
        initialState.setAccepting(true);
        station.setInitialState(initialState);
        
        State workState = station.createUniqueState("q");
        station.addState(workState);
    ...
    public void createIO(int table_id)
    {
        ...
        if (table_id == 0)
        {
            ...
            State initialState = createNewState(IO,"q");
        ...
        else if ((table_id == 1) || (table_id == 2) || (table_id == 3) || (table_id == 4))
        {
            ...
            State workState1 = createNewState(IO,"q");
            State workState2 = createNewState(IO,"q");
            State workState3 = createNewState(IO,"q");
        ...
        else if (table_id == 11)
        {
            ...
            State workState = createNewState(IO,"q");
