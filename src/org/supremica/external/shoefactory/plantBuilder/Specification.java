...
public class Specification
{
    ...
    LabeledEvent get1Event, get2Event, get3Event, get4Event, get5Event,
        get6Event;
    LabeledEvent put7Event, put8Event, put9Event, put10Event, put11Event,
        put12Event;
    LabeledEvent get7Event, get8Event, get9Event, get10Event, get11Event,
        get12Event;
    LabeledEvent putR1Event, putR2Event, putR3Event, putR4Event, putR5Event,
        putR10Event;
    LabeledEvent getL1Event, getL2Event, getL3Event, getL4Event, getL5Event,
        getL10Event;
    State tab1, tab2, tab3, tab4, tab5, g1, g2, g3, g4, g5, g6, g7;
    State h1, h2, h3, h4, h5, h6, h7;
    State i1, i2, i3, i4, i5, i6, i7;
    State s0ret1, s0ret2, s0ret3, s0ret4, s0ret5, s0ret6, s0ret7, s0ret8,
        s0ret9, s0ret10, s0ret11, s0ret12, s0ret13, s0ret14, s0ret15;
    State tab7, tab8, tab9, tab10, tab11, tab12;
    State E1, E2, E3, E4, E5, E6, E7, E8, E9, E10, E11, E12, E13, E14, E15,
        E16, E17, E18, E19, E20, E21, E22, E23, E24;
    Arc EA1, EA2, EA3, EA4, EA5, EA6, EA7, EA8, EA9, EA10, EA11, EA12, EA13,
        EA14, EA15, EA16, EA17, EA18, EA19, EA20, EA21, EA22, EA23, fr6;
    State Er2;
    ...
    public Specification(int nr, boolean[] sv)
    {
        ...
        State sInitial = currShoe.createUniqueState("q");
        currShoe.addState(sInitial);
        
        sInitial.setInitial(true);
        sInitial.setAccepting(true);
        currShoe.setInitialState(sInitial);
        
        State s0 = currShoe.createUniqueState("q");
        currShoe.addState(s0);
        ...
        if (sv[0] || sv[1] || sv[2] || sv[3] || sv[4])
        {
            ...
            h1 = currShoe.createUniqueState("q");
            currShoe.addState(h1);
            
            State tab6 = currShoe.createUniqueState("q");
            currShoe.addState(tab6);
            
            if (allowerror)
            {
                Er2 = currShoe.createUniqueState("q");
                currShoe.addState(Er2);
            }
 ...
 */
        if (allowerror)
        {
            ...
            if (viatable[0])
            {
                ...
                {
                    tab1 = currShoe.createUniqueState("q");
                    currShoe.addState(tab1);
            ...
            if (viatable[1])
            {
                ...
                s0ret5 = currShoe.createUniqueState("q");
                currShoe.addState(s0ret5);
                ...
                if (sv[9] || sv[10] || sv[11])
                {
                    tab2 = currShoe.createUniqueState("q");
                    currShoe.addState(tab2);
            ...
            if (viatable[2])
            {
                ...
                tab3 = currShoe.createUniqueState("q");
                currShoe.addState(tab3);
                g4 = currShoe.createUniqueState("q");
                currShoe.addState(g4);
                ...
                s0ret7 = currShoe.createUniqueState("q");
                currShoe.addState(s0ret7);
            ...
            if (viatable[3])
            {
                ...
                {
                    tab4 = currShoe.createUniqueState("q");
                    currShoe.addState(tab4);
                    g5 = currShoe.createUniqueState("q");
                    currShoe.addState(g5);
                    s0ret9 = currShoe.createUniqueState("q");
                    currShoe.addState(s0ret9);
            ...
            if (sv[0] || sv[1] || sv[2] || sv[3] || sv[4])
            {
                E1 = currShoe.createUniqueState("q");
                currShoe.addState(E1);
                E2 = currShoe.createUniqueState("q");
                currShoe.addState(E2);
                E3 = currShoe.createUniqueState("q");
                currShoe.addState(E3);
                E4 = currShoe.createUniqueState("q");
                currShoe.addState(E4);
                E5 = currShoe.createUniqueState("q");
                currShoe.addState(E5);
                E6 = currShoe.createUniqueState("q");
                currShoe.addState(E6);
                E7 = currShoe.createUniqueState("q");
                currShoe.addState(E7);
                E8 = currShoe.createUniqueState("q");
                currShoe.addState(E8);
                E9 = currShoe.createUniqueState("q");
                currShoe.addState(E9);
                E10 = currShoe.createUniqueState("q");
                currShoe.addState(E10);
                E11 = currShoe.createUniqueState("q");
                currShoe.addState(E11);
                E12 = currShoe.createUniqueState("q");
                currShoe.addState(E12);
                E13 = currShoe.createUniqueState("q");
                currShoe.addState(E13);
                E14 = currShoe.createUniqueState("q");
                currShoe.addState(E14);
                E15 = currShoe.createUniqueState("q");
                currShoe.addState(E15);
                E16 = currShoe.createUniqueState("q");
                currShoe.addState(E16);
                E17 = currShoe.createUniqueState("q");
                currShoe.addState(E17);
                E18 = currShoe.createUniqueState("q");
                currShoe.addState(E18);
                E19 = currShoe.createUniqueState("q");
                currShoe.addState(E19);
                E20 = currShoe.createUniqueState("q");
                currShoe.addState(E20);
                E21 = currShoe.createUniqueState("q");
                currShoe.addState(E21);
                E22 = currShoe.createUniqueState("q");
                currShoe.addState(E22);
        ...
        if (sv[21] || sv[22] || sv[23])
        {
            ...
            {
                s0ret14 = currShoe.createUniqueState("q");
                currShoe.addState(s0ret14);
            }
            ...
            tab11 = createNewState(currShoe,"q");
...
//This option is kept, if you want to use station 20 in the production instead
                ...
                /*      if(sv[20])
                                ...
                                if(sv[5] || sv[6] || sv[6]|| sv[8] || sv[9] || sv[10] || sv[11])
                                {
                                                ...
                                                get3Event =     new LabeledEvent("Shoe_"+shoeNr+"get_T3R");
                                                currAlphabet.addEvent(get3Event);
                                                tab3 = createNewState(currShoe,"q");
                                                g4 = createNewState(currShoe,"q");
                                                ...
                                                tab4 = createNewState(currShoe,"q");
                                                g5 = createNewState(currShoe,"q");
                                                ...
                                                //State ret10 = createNewState(currShoe,"q");
                                                ...
                                                if(!(sv[16]||sv[17]||sv[18]||sv[19]))
                                                {
                                                                ...
                                                                State stat20 = createNewState(currShoe,"q");
                                                ...
                                                State if10 = createNewState(currShoe,"q");
        ...
        if (sv[16] || sv[17] || sv[18] || sv[19])
        {
            ...
            tab12 = createNewState(currShoe,"q");
            ...
            Arc ag6p = new Arc(g6, s0ret13, putR10Event);
                        ...
                        /*if(sv[20])
                        {
                                        ...
                                        currAlphabet.addEvent(gt10s20);
                                        State stat20 = createNewState(currShoe,"q");
                                        //State s0ret15=createNewState(currShoe,"q");
        ...
        if (sv[12] || sv[13] || sv[14] || sv[15])
        {
            ...
            tab9 = createNewState(currShoe,"q");
...
//visit table 8
        if (sv[9] || sv[10] || sv[11])
        {
            ...
            tab8 = createNewState(currShoe,"q");
        ...
        if (sv[5] || sv[6] || sv[7] || sv[8])
        {
            ...
            tab7 = createNewState(currShoe,"q");
        ...
        if (sv[0] || sv[1] || sv[2] || sv[3] || sv[4])
        {
            h2 = createNewState(currShoe,"q");
            h3 = createNewState(currShoe,"q");
