...
import org.supremica.external.shoefactory.Executor.FactoryExecutor;
	...
	implements ActionListener
{
	...
	private static String printValueState(final CS_CtrlMngr ctrl_mngr, final int variable, final int value)
	{
		...
		case CS_CtrlMngr.VALUE_FORCEABLE :
			state = "Forceable";
			break;

		case CS_CtrlMngr.VALUE_BLOCKED :
			state = "Blocked";
			break;

		case CS_CtrlMngr.VALUE_SELECTABLE :
			state = "Selectable";
			break;

		case CS_CtrlMngr.VALUE_USER_SELECTED :
			state = "User Selected";
			break;

		case CS_CtrlMngr.VALUE_SYS_SELECTED :
		...
		if (e.getSource() == JC)
		{
			...
			else
			{
				...
				if (selection == JOptionPane.OK_OPTION)
				{
					...
					fe.start(cc.getConfig(ctrl_mngr.getValueName(3, ctrl_mngr.getSelectedValue(3)), ctrl_mngr.getValueName(1, ctrl_mngr.getSelectedValue(1)), ctrl_mngr.getValueName(2, ctrl_mngr.getSelectedValue(2)), ctrl_mngr.getValueName(0, ctrl_mngr.getSelectedValue(0)), ctrl_mngr.getValueName(4, ctrl_mngr.getSelectedValue(4)), ctrl_mngr.getValueName(5, ctrl_mngr.getSelectedValue(5))), gui);
					ctrl_mngr.resetConf();
					Res_Sellist();
					reset();
