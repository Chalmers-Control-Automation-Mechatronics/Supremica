 ...
 *
 * @author LC 
 * @Created on May 25, 2009 4:10:44 PM
 * 
*/
...
import org.supremica.external.operationframeworkto61131.layout.common.Position;
	...
	public class SimultaneousDivergence extends CommonLayoutObject {

		// FIXME move to Constant
		public static final int objHeight = 3;
		public static final int widthUnit = 120;

		public SimultaneousDivergence(int localId, int numOfConOut) {
...
//			Width equal the position.x of last connectionPointOut
		...
		public Body.SFC.SimultaneousDivergence getPLCOpenObject() {

			Body.SFC.SimultaneousDivergence simultaneousDivergence = CommonLayoutObject.objectFactory.createBodySFCSimultaneousDivergence();

			try {
				super.getPLCopenObject(simultaneousDivergence);
				super.getCommenConInPLCOpenObject(simultaneousDivergence);
				...
				if (!super.getConnectionPointOutList().isEmpty()) {
					for (org.supremica.external.operationframeworkto61131.layout.common.ConnectionPointOut connectionPointOut : super
						...
						simultaneousDivergence
								...
								.add(
										this
												.getSimultaneousDivergenceConnectionPointOutPLCopenObj(connectionPointOut));
					}
				}
			} catch (Exception e) {
		...
		private Body.SFC.SimultaneousDivergence.ConnectionPointOut getSimultaneousDivergenceConnectionPointOutPLCopenObj(
				org.supremica.external.operationframeworkto61131.layout.common.ConnectionPointOut connectionPointOut) {
			
			Body.SFC.SimultaneousDivergence.ConnectionPointOut conOut = CommonLayoutObject.objectFactory.createBodySFCSimultaneousDivergenceConnectionPointOut();
