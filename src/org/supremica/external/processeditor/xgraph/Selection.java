...
public class Selection {
     ...
     * @param graph
     */
    public void setGraph(final JPanel graph) {
	this.graph = graph;
    }
    /**
     ...
     * to select.
     */
    public void add(final CellEvent cEvent) {
	//DEBUG
	//System.out.println("Selection.add()");
	//END DEBUG
	final GraphCell c = cEvent.getSource();
	if(isSelected(new CellEvent(c)) == -1) {
	    final CellSelection[] tmpSelections = selections;
     ...
     *
     */
    public void remove(final CellEvent cEvent) {
	//DEBUG
	//System.out.println("Selection.remove()");
	//END DEBUG
	final GraphCell c = cEvent.getSource();
	final int index = isSelected(new CellEvent(c));
	if(index != -1) {
	    final CellSelection[] tmpSelections = selections;
	    selections = new CellSelection[tmpSelections.length-1];
	    int j = 0;
     ...
     */
    public int isSelected(final CellEvent cEvent) {
	final GraphCell c = cEvent.getSource();
	int index = -1;
	for(int i = 0; i < selections.length; i++) {
     ...
     */
    public void moveSelected(final CellEvent cEvent) {
	//DEBUG
	//System.out.println("Selection.moveSelected()");
	//END DEBUG
	final Point newOrigo = cEvent.getPos();
	for(int i = 0; i < selections.length; i++) {
     ...
     */
    public void setOrigo(final CellEvent cEvent) {
	origo = cEvent.getPos();
    }
    /**
	 ...
	 * to select.
	 */
	public CellSelection(final CellEvent cEvent) {
	    //DEBUG
	...
	public void setSelection() {
	    ...
	    //END DEBUG
	    final int x1 = selection.getPos().x;
	    final int y1 = selection.getPos().y;
	    final int x2 = x1 + selection.getSize().width;
	    final int y2 = y1 + selection.getSize().height;
	 ...
	 */
	public void setSelectedCellPos(final Point p) {
	 ...
	 */
	public void translateSelectedCellPos(final int dx, final int dy) {
	 ...
	 *
	 * @return <code>true</code> if it has selection,
	 * <code>false</code> otherwise.
	 */
	 ...
	 * <code>false</code> otherwise.
	 */
	public boolean isSelected(final CellEvent cEvent) {
	    if(isSelected() &&
