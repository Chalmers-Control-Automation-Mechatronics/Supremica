...
public class GraphCell extends JPanel implements MouseListener,
     ...
     */
    public GraphCell(final String s) {
	this();
	name = s;
    }
    /**
     ...
     */
    public void addCellListener(final CellListener cl) {
	//DEBUG
     ...
     */
    public Point getPos(final int i) {
	final Point move = getAnchorPos(i);
	final Point pos = getPos();
     ...
     */
    public Point getAnchorPos(final int i) {
	int moveX = 0;
	int moveY = 0;
	switch(i) {
	case CENTER:
