...
public class Converter {
	...
	try {
	    ...
	    final Iterator<?> actRelGroupIterator =  actRelGroup.iterator();
	    while(actRelGroupIterator.hasNext()) {
		final Object o = actRelGroupIterator.next();
     ...
     */
    public static void printActivity(final Activity activity) {
	try {
	    final List<?> predecessorList = activity.getPrecondition().getPredecessor();
	    final Iterator<?> predecessorIterator = predecessorList.iterator();
	    while(predecessorIterator.hasNext()) {
		final Object o = predecessorIterator.next();
	...
	try {
	    final List<?> attributeList = activity.getProperties().getAttribute();
	    final Iterator<?> attributeIterator = attributeList.iterator();
	    while(attributeIterator.hasNext()) {
		final Object o = attributeIterator.next();
     ...
     */
    public static Object convertStringToActivityRelation(final String algebraic) {
    	if(!algebraic.equals("")) {
     ...
     */
    public static RelationType getType(final String algebraic) {
    	int startParantes = 0;
    	int endParantes = 0;
     ...
     */
    public static String getFirstExpression(final String func, final char operator) {
    	final int operatorIndex = getOperatorIndex(func, operator);
    	if(operatorIndex > 0) {
     ...
     */
    public static String getRestOfExpression(final String func, final char operator) {
    	final int operatorIndex = getOperatorIndex(func, operator);
    	if(operatorIndex > -1) {
     ...
     */
    public static int getOperatorIndex(final String func, final char operator) {
    	int parenthesis = 0;
    ...
    public static int numOfActivities(final Object o) {
    	if(o instanceof ROP) {
    		...
    		final Iterator<?> actRelGroupIterator = ((Relation)o).getActivityRelationGroup().iterator();
     ...
     */
    public static Activity getActivityAt(final Object o, int i) {
    	if(o instanceof ROP) {
    		return getActivityAt(((ROP)o).getRelation(), i);
    	}else if(o instanceof Relation) {
    		final Iterator<?> actRelGroupIterator = ((Relation)o).getActivityRelationGroup().iterator();
    		while(actRelGroupIterator.hasNext()) {
    			final Object tmp = actRelGroupIterator.next();
	...
	if(o instanceof ROP) {
		...
		final ROP newROP = objectFactory.createROP();
		try {
		...
		final Activity newActivity = objectFactory.createActivity();
		try {
		...
		try {
			...
			final Iterator<?> iterator = ((Activity)o).getProperties().getAttribute().iterator();
			while(iterator.hasNext()) {
			    try {
		...
		final OperationReferenceType newPredecessor = objectFactory.createOperationReferenceType();
		try {
	    ...
	    try {
	    	...
	    	final Algebraic newAlgebraic = objectFactory.createAlgebraic();
	    	try {
		...
		final Attribute newAttribute = objectFactory.createAttribute();
		try {
     ...
     */
    public static String[] getUniqueAttributes(final Object o) {
	//DEBUG
     ...
     * @return the array including all the unique attribute types
     */
    private static String[] getUniqueAttributes(final Object o, String[] attributes) {
	//DEBUG
	...
	if(o instanceof ROP) {
		...
		while(iterator.hasNext()) {
		    ...
		    try {
			final String[] uniqueAttribute = getUniqueAttributes(next, attributes);
	    ...
	    final String[] uniqueAttribute = new String[1];
	    try{
     ...
     */
    private static String[] mergeStringArray(final String[] m, final String[] n) {
	final String[] str = new String[m.length+n.length];
     ...
     *
     */
    public static int isAttributeTypeVisible(final Object o, final String type) {
     ...
     */
    private static int[] attributeVisibleCount(final Object o, final String type, int[] visibleCount) {
	try {
	    if(o instanceof ROP) {
     ...
     */
    public static Object setUniqueNames(final Object objectToCheck,
					final Object objectToSet) {
	//DEBUG
	...
	try {
		...
		try{
		    ...
		    final Relation objectToReturn = objectFactory.createRelation();
		    objectToReturn.setType(((Relation)objectToSet).getType());
		    final Iterator<?> iterator = ((Relation)objectToSet).getActivityRelationGroup().iterator();
		    while(iterator.hasNext()) {
		...
		try{
		    final String name = ((Activity)objectToSet).getOperation();
     ...
     */
    public static boolean isNameUnique(final Object o, final String name) {
     ...
     * <code>false</code>
     */
    public static boolean isExtended(final Object o) {
     ...
     */
    private static int[] extendedCount(final Object o, int[] extendedCount) {
	try {
	    if(o instanceof ROP) {
     ...
     */
    public static String[] getPredecessors(final Object o) {
     ...
     * @param o the object
     */
    public static void removeComment(final Object o) {
    	//DEBUG
     ...
     * @param o the object
     */
    public static void removeAlgebraic(final Object o) {
    	//DEBUG
     ...
     * @param o the object
     */
    public static void removePrecondition(final Object o) {
    	//DEBUG
     ...
     * @param o the object
     */
    public static void removeProperties(final Object o) {
	//DEBUG
     ...
     * @param o the object
     */
    public static void removePredecessor(final Object o) {
	//DEBUG
     ...
     * @param o the object
     */
    public static void removeAlgebraicUnextended(final Object o) {
	//DEBUG
     ...
     * @param o the object
     */
    public static void removeActivityUnextended(final Object o) {
	//DEBUG
	...
	if(o instanceof ROP) {
		...
		final Properties newProperties = objectFactory.createProperties();
		final Iterator<?> iterator = ((Activity)o).getProperties().getAttribute().iterator();
		while(iterator.hasNext()) {
     ...
     * @param o the object
     */
    public static void removeAttribute(final Object o) {
	//DEBUG
     ...
     * xml-element is removed, otherwise <code>false</code>
     */
    public static void removeAttributeCharacteristics(final Object o,
						      final boolean rmUpperIndicator,
						      final boolean rmLowerIndicator,
						      final boolean rmInvisible) {
	//DEBUG
     ...
     */
    public static float sumAttribute(final Object o, final String type) {
	if(o instanceof ROP) {
