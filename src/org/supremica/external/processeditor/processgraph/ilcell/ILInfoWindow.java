							...
							ActionListener
{
     ...
     * @param ilCell an InterLockCell that is to be edited by this info window
     */
    public ILInfoWindow( final InterLockCell ilCell ){
    	this( ilCell.getIL() );
    	this.ilCell = ilCell;
    ...
    /**
     * Creates a new instance of the class.
     * @param il the object that is to be edit by this info window
     */
    public ILInfoWindow(final IL il){
    	super( TITLE );
    ...
    protected void initMenu(){
    	...
    	//    Table menu
    	//---------------------------------------------------------------------
    	final JMenu tableMenu = new JMenu( "Table" );
    ...
    public void saveAs(){
        ...
        final int tmp = fc.getFileSelectionMode();
    ...
    private void updateIL(){
		...
		final ILStructure ils = tableGroup.getILStructure();
    ...
    private static void createAndShowGUI() {
    	...
    	final IL il = factory.createIL();

    	final ILInfoWindow ilInfoWin = new ILInfoWindow(il);
