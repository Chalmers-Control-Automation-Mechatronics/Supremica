...
public class EOPTableExtractor {
	...
	{
		final InternalComponents internalComponents = factory.createInternalComponents();
		final int numberOfComponents = table.getColumnCount();
	...
	public static ExternalComponentValue[]
		getExternalComponentsInitialValueFromTable(final BasicTable table)
	{
		/*
		...
		final int row = 1; // row there value is to find

		ExternalComponent extComp = null;
		final int numberOfComponents = table.getColumnCount();
		final ExternalComponentValue[] extComponents = new ExternalComponentValue[numberOfComponents];
	 ...
	 */
	public static Action[] getActions(final BasicTable tableId,
									  ...
									  final BasicTable tableZone)
	{
		...
		final Action[] actions = new Action[numberOfRows - 1];
	 ...
	 * @param table
	 */
	private static void addInternalComponentsActionState(final Action[] actions, final BasicTable table){
	 ...
	 * @param table
	 */
	private static void addExternalComponentsActionState(final Action[] actions, final BasicTable table){
	 ...
	 * @param table
	 */
	private static void addZoneActionState(final Action[] actions, final BasicTable table){
	 ...
	 * @param table
	 */
	private static void addIdActionState(final Action[] actions, final BasicTable table){
		int numberOfColumns = -1;
		if(null == table || null == actions || 0 == actions.length){
			return;
		}
