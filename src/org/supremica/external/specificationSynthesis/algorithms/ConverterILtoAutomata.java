...
public class ConverterILtoAutomata {

	Document AutomataDoc;
	Element automata = new Element("Automata");

	public ConverterILtoAutomata() {
	...
	public void convertILtoAutomata(Document PAdoc) {
		...
		// Build interlocking automata from the XML document referenced by
		// PAroot, and put it in the element automata.
