...
public class CheckSeq {
	...
	Vector predecessor_vector;
	ConverterSTEPtoPA steptopa;

	public CheckSeq() {

		predecessor_vector = new Vector();
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	public boolean checkIfInSeqGroup(String id, String related, Element root)
	{
		...
		Element id_element = steptopa.getPOOelement(id);
		Element related_element = steptopa.getPOOelement(related);
