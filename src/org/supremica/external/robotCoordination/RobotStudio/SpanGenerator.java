    ...
    extends SimulationListener
{
	...
	try
		...
		//spans.delete();
		unionEntity.setName(pathName + RSCell.SPAN_SUFFIX);
		unionEntity.setColor(RSCell.RS_BLUE);
		...
		temp.setColor(RSCell.RS_RED);
		temp.setRelativeTransparency((float) 0.9);
		RSCell.station.getSelections().removeAll();
	...
	RSCell.station.setUCS(upperArm);
