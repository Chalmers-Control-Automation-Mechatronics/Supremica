...
/**
 * Interface for representing a robot in the simulation environment.
 */
public interface Robot
{
	/**
	 * Makes <code>listener</code> a listener for events generated by
	 * this robot (collisions for example).
	 *
	 * @see RobotListener
	 */
    ...
    /**
     * Returns true if the robot collides with a given volume.
     */
     ...
     */
    public void generateSpan(Configuration from, Configuration to)  // Should return a Volume!!
		throws Exception;
	
    /**
     * Hides span in simulation environment (just for esthetics)
     */
    public void hideSpan()   // Should be done through something like Volume.hide().
		throws Exception;
