...
/**
 * The TimeVariable class is used to represent a time variable 
 * (input, output or internal) in SMV. 
 * According to IEC 61131-1, times are represented as for instance t#12ms or t#23m1s etc.
 * Right now, I assume that the time is always in ms and is written as an integer.
 *
 *
 * Created: Wed May 14 17:40:12 2008
 *
 * @author Oscar
 * @version 1.0
 */
