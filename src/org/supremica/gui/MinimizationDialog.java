    ...
    implements ActionListener
{
     ...
     */
    public MinimizationDialog(Frame parentFrame, MinimizationOptions options, Automata automata)
    {
        ...
        implements ActionListener
    {
        ...
        {
            minimizationTypeBox = new JComboBox(EquivalenceRelation.values());
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            else if ((minimizationTypeBox.getSelectedItem()) == EquivalenceRelation.SUPERVISIONEQUIVALENCE)
            {
                note.setText("Note:\n" + "This minimization algorithm is experimental! The\n" +
                    "result may not be minimal but should at least be\n" +
        ...
        implements ActionListener
    {
        ...
        private JComboBox minimizationHeuristic;
