...
{
	private static ImageIcon ordinaryStateIcon = 
		new ImageIcon(Supremica.class.getResource("/icons/State16.gif"));
	private static ImageIcon markedStateIcon = 
		new ImageIcon(Supremica.class.getResource("/icons/MarkedState16.gif"));
	private static ImageIcon markedInitialStateIcon = 
		new ImageIcon(Supremica.class.getResource("/icons/MarkedInitialState16.gif"));
	private static ImageIcon forbiddenInitialStateIcon = 
		new ImageIcon(Supremica.class.getResource("/icons/ForbiddenInitialState16.gif"));
	private static ImageIcon initialStateIcon = 
		new ImageIcon(Supremica.class.getResource("/icons/InitialState16.gif"));
	private static ImageIcon forbiddenStateIcon = 
		new ImageIcon(Supremica.class.getResource("/icons/ForbiddenState16.gif"));
