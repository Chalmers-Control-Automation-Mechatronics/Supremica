...
//		this.workbench = workbench;
	...
	public void run()
	{
		...
		// Update labels
		boolean showValues = (currentMode == ExecutionDialogMode.synchronizing ||
			currentMode == ExecutionDialogMode.verifying ||
			currentMode == ExecutionDialogMode.synthesizing);

		boolean showProgress = (currentMode == ExecutionDialogMode.buildingStates ||
			currentMode == ExecutionDialogMode.buildingTransitions);
