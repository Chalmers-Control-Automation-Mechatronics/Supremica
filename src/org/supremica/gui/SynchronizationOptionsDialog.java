...
/*
	...
	private JCheckBox expandUncontrollableStatesCheckBox;
	private JCheckBox forbidUncontrollableStatesCheckBox;
	private JTextField nbrOfThreadsTextField;
	private JTextField hashtableSizeTextField;

	public SynchronizationOptionsDialog(Frame owner)
	{
		super(owner, "Synchronization options", true);
		...
		expandUncontrollableStatesCheckBox = new JCheckBox("Expand uncontrollable states");
		forbidUncontrollableStatesCheckBox = new JCheckBox("Forbid uncontrollable states");
	...
	public boolean doExpandUncontrollableStates()
	{

	}

	public boolean doForbidUncontrollableStates()
	{
