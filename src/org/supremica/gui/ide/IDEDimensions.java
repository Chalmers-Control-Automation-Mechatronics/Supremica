...
{
	public static Dimension mainWindowPreferredSize = new Dimension(1000, 650);
	public static Dimension mainWindowMinimumSize = new Dimension(100, 100);

	public static Dimension loggerPreferredSize = new Dimension(1000, 150);
	public static Dimension loggerMinimumSize = new Dimension(100, 10);

	public static Dimension mainPanelPreferredSize = new Dimension(600, 500);
	public static Dimension mainPanelMinimumSize = new Dimension(100, 50);

	public static Dimension leftEditorPreferredSize = new Dimension(300, 500);
	public static Dimension leftEditorMinimumSize = new Dimension(50, 50);

	public static Dimension rightEditorPreferredSize = new Dimension(500, 500);
	public static Dimension rightEditorMinimumSize = new Dimension(50, 50);

	public static Dimension leftAnalyzerPreferredSize = new Dimension(400, 650);
