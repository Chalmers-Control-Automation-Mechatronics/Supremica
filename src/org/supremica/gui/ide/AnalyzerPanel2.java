...
public class AnalyzerPanel2
    extends MainPanel
{
    private static final long serialVersionUID = 1L;

    private final JComponent automatonViewerPanel;
    private final AnalyzerAutomataPanel2 automataPanel;

    private final DocumentContainer mDocumentContainer;
    private final VisualProject mVisualProject = new VisualProject();

    public AnalyzerPanel2(final DocumentContainer moduleContainer, final String name)
    {
        super(name);

        mDocumentContainer = moduleContainer;

        automataPanel = new AnalyzerAutomataPanel2(this, moduleContainer);
