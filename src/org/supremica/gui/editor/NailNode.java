	...
	extends JGoArea
{
	...
	protected NailPort thePort = null;
	...
	{
		NailNode newobj = (NailNode) super.copyObject(env);
	...
	public void copyChildren(JGoArea newarea, JGoCopyEnvironment env)
	{
		...
		NailNode newobj = (NailNode) newarea;
		...
		NailPort op = thePort;
		NailPort np = (NailPort) op.copyObject(env);
	...
	/**
	 * Keep the parts of a NailNode positioned relative to each other
