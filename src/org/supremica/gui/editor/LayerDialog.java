...
public class LayerDialog extends JDialog {
  ...
  void UpdateControl()
  {
    if (myView != null)
    {
      ...
      myAutoLayout = new SimpleLDAL(doc, Integer.parseInt(layer.getText()),
          Integer.parseInt(column.getText()), direction, cycle, layering, initialize,
          Integer.parseInt(iter.getText()), agr, myApp);
    }
  }
