...
public class TransitionParser/*@bgen(jjtree)*/implements TransitionParserTreeConstants, TransitionParserConstants {/*@bgen(jjtree)*/
...
//    System.out.println(n.evaluate());
  ...
  static final public TRStart Start() throws ParseException {
                   /*@bgen(jjtree) Start */
 ...
 /*@bgen(jjtree) Var */
  ...
  static final public void Evuvar() throws ParseException {
 /*@bgen(jjtree) Evuvar */
  ...
  static final public void Evdvar() throws ParseException {
 /*@bgen(jjtree) Evdvar */
  ...
  static final private boolean jj_3R_13() {
    if (jj_scan_token(EVDVAR)) return true;
    if (jj_la == 0 && jj_scanpos == jj_lastpos) return false;
    return false;
  }
  ...
  static final private boolean jj_3R_12() {
    if (jj_scan_token(EVUVAR)) return true;
    if (jj_la == 0 && jj_scanpos == jj_lastpos) return false;
    return false;
  }
