 ...
 */
public class ExitStep extends GCStep implements GCIdent
{
...
//      stepCounter++;
    ...
    myInline.addPoint(20,0);
    myInline.addPoint(20,10);
...
//     myLabel.setSpotLocation(LeftCenter,60,60);
    ...
    if (myArrow != null) {
      myArrow.setSpotLocation(TopCenter, myRectangle, BottomCenter); }
    if (myInline != null){
