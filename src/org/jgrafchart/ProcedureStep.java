...
public class ProcedureStep extends MacroStep implements Readable {
...
//    System.out.println("procedure.myContDoc " + procedure.myContentDocument);
    ...
    for (Iterator i = symbolList.iterator(); 
             !found && i.hasNext();) {
    o1 = (Object)i.next();
...
//    System.out.println("symbolList " + symbolList);
    ArrayList sl = viewOwner.getBasicApp().compileDocument(
                                           myContentDocument, symbolList); 
