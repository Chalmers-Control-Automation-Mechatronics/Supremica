 ...
 * Two views. 
 */
public class Basic2GC extends JFrame 
{ //Constructor
  public Basic2GC()
  {
...
//    initView();
  ...
  AppAction CompileAction = new AppAction("Compile", this) {
      public void actionPerformed(ActionEvent e) {compileAction();}
...
//&&  !getView().executing && getView().compiledOnce;}};
  ...
  AppAction ExecuteAction = new AppAction("Execute", this) {
      public void actionPerformed(ActionEvent e) {executeAction();}
public boolean canAct() {return super.canAct() && getApp().topLevelView
&& !getView().executing && getView().compiledOnce;}};
...
getView().executing;}};
  ...
  AppAction DebugAction = new AppAction("Debug", this) {
      public void actionPerformed(ActionEvent e) {debugAction();}};
...
public boolean canAct() { return super.canAct() && !getView().getSelection().isEmpty();}};
  ...
  AppAction ZoomCopyAction = new AppAction("Copy", this) {
      public void actionPerformed(ActionEvent e) {copyAction();}
      public boolean canAct() { return super.canAct() && !getView().getSelection().isEmpty();}};
  ...
  AppAction ShowActionBlockAction = new AppAction("Show Action Block", this) {
      public void actionPerformed(ActionEvent e) {showActionBlockAction(e);}
      public boolean canAct() { return super.canAct() && (getApp().selectedObject != null) && (getApp().selectedObject instanceof GCStep) && !((GCStep)getApp().selectedObject).actionBlockVisible;}};

  AppAction HideActionBlockAction = new AppAction("Hide Action Block", this) {
      public void actionPerformed(ActionEvent e) {hideActionBlockAction(e);}
      public boolean canAct() { return super.canAct() && (getApp().selectedObject != null) && (getApp().selectedObject instanceof GCStep) && ((GCStep)getApp().selectedObject).actionBlockVisible;}};
  ...
  AppAction TransitionEditAction = new AppAction("Edit", this) {
      public void actionPerformed(ActionEvent e) {transitionEditAction(e);} };

  AppAction StepEditAction = new AppAction("Edit", this) {
      public void actionPerformed(ActionEvent e) {stepEditAction(e);} };


  AppAction ProcedureStepEditAction = new AppAction("Edit", this) {
      public void actionPerformed(ActionEvent e) {procedureStepEditAction(e);} };

  AppAction ProcedureStepShowAction = new AppAction("Call", this) {
      public void actionPerformed(ActionEvent e) {procedureStepShowAction(e);} };
...
//    grafcetmenu.add(DebugAction);
  ...
  void newAction() {
    ...
    final JInternalFrame frame = new JInternalFrame(doc.getName(), true, 
                                                    true, true, true);
...
//  --------------------- Procedure Step menu Actions -------------------
    ...
    public void initPalette()
  {
    ...
    JGoText textVar = new JGoText(new Point(45,25), 14, 
initString,"Serif",true,false,false,JGoText.ALIGN_CENTER,false,true);
    ...
    JGoText textVar1 = new JGoText(new Point(45,160), 12, 
initString1,"Serif",true,false,false,JGoText.ALIGN_CENTER,false,true);
    ...
    JGoText textVar2 = new JGoText(new Point(45,280), 12, 
initString2,"Serif",true,false,false,JGoText.ALIGN_CENTER,false,true);
    ...
    JGoText textVar3 = new JGoText(new Point(45,345), 12, 
initString2,"Serif",true,false,false,JGoText.ALIGN_CENTER,false,true);
    ...
    JGoText textVar4 = new JGoText(new Point(45,395), 12, 
initString2,"Serif",true,false,false,JGoText.ALIGN_CENTER,false,true);
    ...
    JGoText textVar5 = new JGoText(new Point(45,440), 12, 
initString2,"Serif",true,false,false,JGoText.ALIGN_CENTER,false,true);
    ...
    JGoText textVar6 = new JGoText(new Point(45,560), 12, 
initString2,"Serif",true,false,false,JGoText.ALIGN_CENTER,false,true);
    ...
    JGoText textVar7 = new JGoText(new Point(45,630), 12, 
initString2,"Serif",true,false,false,JGoText.ALIGN_CENTER,false,true);
...
//    paletteDoc.addObjectAtTail(pst);
    ...
    JGoText textVar8 = new JGoText(new Point(45,765), 12, 
initString2,"Serif",true,false,false,JGoText.ALIGN_CENTER,false,true);
    ...
    initString2 = "Digital Input";
    JGoText textVar45 = new JGoText(new Point(45,895), 12, 
initString2,"Serif",true,false,false,JGoText.ALIGN_CENTER,false,true);
    ...
    JGoText textVar46 = new JGoText(new Point(45,908), 12, 
initString2,"Serif",true,false,false,JGoText.ALIGN_CENTER,false,true);
    ...
    JGoText textVar9 = new JGoText(new Point(45,1040), 12, 
initString2,"Serif",true,false,false,JGoText.ALIGN_CENTER,false,true);
    ...
    initString2 = "Digital Output";
    JGoText textVar10 = new JGoText(new Point(45,1170), 12, 
initString2,"Serif",true,false,false,JGoText.ALIGN_CENTER,false,true);
    ...
    initString2 = "(inverse logic)";
    JGoText textVar13 = new JGoText(new Point(45,1183), 12, 
initString2,"Serif",true,false,false,JGoText.ALIGN_CENTER,false,true);
    ...
    JGoText textVar11 = new JGoText(new Point(45,1285), 12, 
initString2,"Serif",true,false,false,JGoText.ALIGN_CENTER,false,true);
    ...
    JGoText textVar12 = new JGoText(new Point(45,1395), 12, 
initString2,"Serif",true,false,false,JGoText.ALIGN_CENTER,false,true);
...
//      handleProcedureStep(ps);
  ...
  public void handleGrafcetProcedure(GrafcetProcedure ms) {
    if (ms.frame == null) {
      ...
      final JInternalFrame frame = new JInternalFrame(ms.myLabel.getText(), 
                                                      true, true, true, true);
      frame.setDefaultCloseOperation(JInternalFrame.DISPOSE_ON_CLOSE);
...
//            view.getDoc().updateLocationModifiable();
  ...
  public void handleProcedureStep(ProcedureStep ms) {
    if ((ms.frame == null) & (ms.myContentDocument != null)) {
      ...
      final JInternalFrame frame = new JInternalFrame("Call to " + ms.myLabel.getText(), 
                                                      true, true, true, true);
      frame.setDefaultCloseOperation(JInternalFrame.DISPOSE_ON_CLOSE);
      final GCView view = new GCView(ms.myContentDocument);
      view.setStepCounter(ms.stepCounterInt);
...
//            view.getDoc().updateLocationModifiable();
  ...
  public void processDocChange(JGoDocumentEvent e) {
    ...
    case JGoDocumentEvent.CHANGED:
      if (
          (e.getJGoObject() instanceof JGoText) && 
          (e.getJGoObject().getParent() != null) &&
	  (e.getFlags() == JGoText.ChangedText) &&
          (e.getJGoObject().getParent() instanceof GenericTransition)) {
...
//	}
      ...
      if ((e.getJGoObject() instanceof JGoText) &&
          (e.getJGoObject().getParent() != null) &&
	  (e.getFlags() == JGoText.ChangedText) &&
          (e.getJGoObject().getParent() instanceof DigitalIn)) {
        JGoText label = (JGoText)e.getJGoObject();
	...
	if (label == digIn.myIntext) {
      ...
      if ((e.getJGoObject() instanceof JGoText) &&
          (e.getJGoObject().getParent() != null) &&
	  (e.getFlags() == JGoText.ChangedText) &&
          (e.getJGoObject().getParent() instanceof BooleanVariable)) {
        JGoText label = (JGoText)e.getJGoObject();
	...
	} else {inVar.setStoredBoolAction(true);
	}
	}
      }
      if ((e.getJGoObject() instanceof JGoText) &&
          (e.getJGoObject().getParent() != null) &&
	  (e.getFlags() == JGoText.ChangedText) &&
          (e.getJGoObject().getParent() instanceof IntegerVariable)) {
        JGoText label = (JGoText)e.getJGoObject();
	...
	if (label == inVar.myValue) {
      ...
      if ((e.getJGoObject() instanceof JGoText) &&
          (e.getJGoObject().getParent() != null) &&
	  (e.getFlags() == JGoText.ChangedText) &&
          (e.getJGoObject().getParent() instanceof StringVariable)) {
        JGoText label = (JGoText)e.getJGoObject();
