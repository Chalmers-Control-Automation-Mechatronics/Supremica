...
public class GCView extends JGoGridView implements JGoViewListener
{
...
//   setGridSpot(JGoObject.Left);
    setGridWidth(10);setGridHeight(10);
    setKeyEnabled(true);
...
//   setGridSpot(JGoObject.Left);
  ...
  public void moveSelection(JGoSelection sel, int flags, int offsetx, int offsety, int event)
  {
    ...
    if ((snapmove == SnapJump) ||
        (snapmove == SnapAfter && event == EventMouseUp)) {
  ...
  public Basic2GC getBasicApp() {return myApp;}



  public JInternalFrame getInternalFrame() {return myInternalFrame;}
...
//          go.viewOwner = this;
//	}
        if (o instanceof GCStep) { //Is this needed?
          GCStep obj = (GCStep)o;
...
private class GrafcetThread extends Thread {
