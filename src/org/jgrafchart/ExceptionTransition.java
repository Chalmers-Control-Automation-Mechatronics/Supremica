...
public class ExceptionTransition extends GenericTransition implements GCIdent {
  ...
  public void setBrush(JGoBrush b)
  {
    ...
    public boolean isStep(){ return false; }
...
//	s.executeNormalActions(true);
  ...
  public JGoObject getRectangle() { return myRectangle; }
  public JGoText getLabel() { return myLabel; }
  public JGoStroke getInline() { return myInline; }
  public JGoStroke getOutline() { return myOutline; }
  public ExceptionTransitionInPort getInPort() { return myInPort; }
  public GCTransitionOutPort getOutPort() { return myOutPort; }
