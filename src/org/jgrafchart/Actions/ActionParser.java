...
public class ActionParser/*@bgen(jjtree)*/implements ActionParserTreeConstants, ActionParserConstants {/*@bgen(jjtree)*/
  ...
  static final public ACTProcParam ProcParam() throws ParseException {
 /*@bgen(jjtree) ProcParam */
  ...
  static final public void procparamstatement() throws ParseException {
    ParameterAssignment();
    jj_consume_token(15);
  }

  static final public void ParameterAssignment() throws ParseException {
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case V:
      jj_consume_token(V);
      Variable();
  ...
  static final public ACTProcCall ProcCall() throws ParseException {
 /*@bgen(jjtree) ProcCall */
  ...
  static final public void proccallstatement() throws ParseException {
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case STRING:
      String();
      break;
  ...
  static final public ACTStatement Statement() throws ParseException {
 ...
 /*@bgen(jjtree) String */
  ...
  static final private int[] jj_la1_0 = {0x8300,0x8300,0x300,0x4400,0x80f0,0x80f0,0xf0,0x20000,0x40000,0x180000,0x180000,0x1e00000,0x1e00000,0x6000000,0x6000000,0x18000000,0x18000000,0x60006400,0x40006400,};
