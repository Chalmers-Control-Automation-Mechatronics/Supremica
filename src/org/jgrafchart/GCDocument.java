...
public class GCDocument extends JGoDocument implements Referencable {
  ...
  public boolean isSimulating() {return simulation;}

  public int getSpeed() {return threadSpeed;}

  public void setSpeed(int s) {threadSpeed = s;}
