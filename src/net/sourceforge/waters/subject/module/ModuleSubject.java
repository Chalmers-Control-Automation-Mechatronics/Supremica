...
//# CLASS:   ModuleSubject
//###########################################################################
//# $Id: ModuleSubject.java,v 1.11 2007-03-02 05:21:14 robi Exp $
//###########################################################################
  ...
  implements ModuleProxy
{
  ...
  public boolean assignFrom(final ProxySubject partner)
  {
    if (this != partner) {
      ...
      final IndexedListSubject<ParameterSubject> parameterList = downcast.getParameterListModifiable();
      mParameterList.assignFrom(parameterList);
      final ListSubject<AliasSubject> constantAliasList = downcast.getConstantAliasListModifiable();
