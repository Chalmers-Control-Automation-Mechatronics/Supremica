...
//# CLASS:   GraphSubject
//###########################################################################
//# $Id: GraphSubject.java,v 1.15 2007-03-08 00:57:12 robi Exp $
//###########################################################################
  ...
  implements GraphProxy
{
  ...
  public boolean assignFrom(final ProxySubject partner)
  {
    if (this != partner) {
      ...
      if (mBlockedEvents != null && blockedEvents != null) {
        mBlockedEvents.assignFrom(blockedEvents);
      } else if (mBlockedEvents == null && blockedEvents != null) {
      ...
      final IndexedSetSubject<NodeSubject> nodes = downcast.getNodesModifiable();
  ...
  public boolean equalsByContents(final Proxy partner)
  {
    if (super.equalsByContents(partner)) {
      ...
      return
        ...
        ProxyTools.equalsByContents(mBlockedEvents, downcast.mBlockedEvents) &&
  ...
  public boolean equalsWithGeometry(final Proxy partner)
  {
    if (super.equalsByContents(partner)) {
      ...
      return
        (mIsDeterministic == downcast.mIsDeterministic) &&
        ProxyTools.equalsWithGeometry(mBlockedEvents, downcast.mBlockedEvents) &&
