...
//###########################################################################
//# $Id: VariableSubject.java,v 1.12 2007-03-08 00:57:12 robi Exp $
//###########################################################################
  ...
  public boolean equalsByContents(final Proxy partner)
  {
    if (super.equalsByContents(partner)) {
      ...
      return
        ...
        ProxyTools.equalsByContents(mMarkedValue, downcast.mMarkedValue);
    } else {
      return false;
    }
  }
  ...
  public boolean equalsWithGeometry(final Proxy partner)
  {
    if (super.equalsByContents(partner)) {
      ...
      return
        ...
        ProxyTools.equalsWithGeometry(mMarkedValue, downcast.mMarkedValue);
    } else {
      return false;
    }
  }
