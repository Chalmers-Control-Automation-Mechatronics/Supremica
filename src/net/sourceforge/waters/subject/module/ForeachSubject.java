...
//###########################################################################
//# $Id: ForeachSubject.java,v 1.12 2007-03-08 00:57:12 robi Exp $
//###########################################################################
  ...
  implements ForeachProxy
{
  ...
  public boolean assignFrom(final ProxySubject partner)
  {
    if (this != partner) {
      ...
      if (mGuard != null && guard != null) {
        mGuard.assignFrom(guard);
      } else if (mGuard == null && guard != null) {
        mGuard = guard.clone();
        mGuard.setParent(this);
        change = true;
      } else if (mGuard != null && guard == null) {
  ...
  public boolean equalsByContents(final Proxy partner)
  {
    if (super.equalsByContents(partner)) {
      ...
      return
        ...
        ProxyTools.equalsByContents(mGuard, downcast.mGuard) &&
  ...
  public boolean equalsWithGeometry(final Proxy partner)
  {
    if (super.equalsByContents(partner)) {
      ...
      return
        ...
        ProxyTools.equalsWithGeometry(mGuard, downcast.mGuard) &&
