...
//###########################################################################
//# $Id: GuardActionBlockSubject.java,v 1.14 2007-03-08 00:57:12 robi Exp $
//###########################################################################
  ...
  implements GuardActionBlockProxy
{
  ...
  public boolean assignFrom(final ProxySubject partner)
  {
    if (this != partner) {
      ...
      final ListSubject<SimpleExpressionSubject> guards = downcast.getGuardsModifiable();
      mGuards.assignFrom(guards);
      final ListSubject<BinaryExpressionSubject> actions = downcast.getActionsModifiable();
