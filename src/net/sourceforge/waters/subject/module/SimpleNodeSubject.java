...
//###########################################################################
//# $Id: SimpleNodeSubject.java,v 1.13 2007-03-08 00:57:12 robi Exp $
//###########################################################################
  ...
  implements SimpleNodeProxy
{
  ...
  public boolean equalsWithGeometry(final Proxy partner)
  {
    if (super.equalsByContents(partner)) {
      ...
      return
        (mIsInitial == downcast.mIsInitial) &&
        ProxyTools.equalsWithGeometry(mPointGeometry, downcast.mPointGeometry) &&
        ProxyTools.equalsWithGeometry(mInitialArrowGeometry, downcast.mInitialArrowGeometry) &&
        ProxyTools.equalsWithGeometry(mLabelGeometry, downcast.mLabelGeometry);
    } else {
      return false;
    }
  }
