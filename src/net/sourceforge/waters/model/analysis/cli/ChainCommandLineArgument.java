 ...
 */
public class ChainCommandLineArgument extends EnumCommandLineArgument<ModelAnalyzerFactoryLoader>
{
    ...
    throws AnalysisException
  {
    for (final Configurable configurable : configurables) {
      if (configurable instanceof ModelAnalyzer) {
        super.parse(context, configurables, iter);
        ...
        try {
          ...
          context.addConfigurable(secondaryAnalyzer);
          context.parse(iter);
