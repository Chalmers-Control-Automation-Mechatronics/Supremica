...
/**
 * A result record returned by a {@link CoobservabilityChecker}. Extends
 * normal verification results by adding statistics about the number of
 * supervisor sites.
 *
 * @author Robi Malik
 */

public interface CoobservabilityVerificationResult extends VerificationResult
{

  //#########################################################################
  //# Simple Access Methods
  /**
   * Gets the number of supervisor sites found in the model to be verified.
   */
  ...
  //#########################################################################
  //# Overrides for net.sourceforge.waters.model.analysis.VerificationResult
  @Override
