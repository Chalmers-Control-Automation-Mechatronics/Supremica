...
public class OldModuleCompiler extends AbstractModuleProxyVisitor
{
 
  //##########################################################################
  //# Constructors
  public OldModuleCompiler(final DocumentManager manager,
  ...
  private class NameCompiler extends AbstractModuleProxyVisitor {
      ...
      throws VisitorException
    {
      ...
      for (final SimpleExpressionProxy index : indexes) {
        final Value value =
          (Value) index.acceptVisitor(OldModuleCompiler.this);
        buffer.append('[');
        buffer.append(value);
        buffer.append(']');
      }
