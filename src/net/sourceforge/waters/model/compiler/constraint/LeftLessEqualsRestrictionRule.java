...
//# CLASS:   LeftLessEqualsRestrictionRule
//###########################################################################
//# $Id$
//###########################################################################
...
class LeftLessEqualsRestrictionRule extends RangeRestrictionRule
{

  //#########################################################################
  //# Construction
  static LeftLessEqualsRestrictionRule createRule
     ...
     final CompilerOperatorTable optable)
  {
    ...
    return new LeftLessEqualsRestrictionRule(template, VARNAME, EXPR);
  }


  //#########################################################################
  //# Constructor
  private LeftLessEqualsRestrictionRule
    (final SimpleExpressionProxy template,
     final IntegerVariablePlaceHolder VARNAME,
     final IntegerExpressionPlaceHolder EXPR)
  {
    ...
    throws EvalException
  {
    ...
    final int max = exprrange.getUpper();
