...
//# CLASS:   MinusExpressionProxy
//###########################################################################
//# $Id: MinusExpressionProxy.java,v 1.1 2005-02-17 01:43:35 knut Exp $
//###########################################################################
...
/**
 * <P>A subtraction expression.
 * The subtraction operator in Waters is written as <CODE>-</CODE>. When
 * evaluated, an subtraction expression returns the sum of its two integer
 * arguments.</P>
 * 
 * <P>Examples:</P>
 * <UL>
 * <LI><CODE>1 - 2</CODE> returns <CODE>-1</CODE>.
 * </UL>
 *
 * @author Robi Malik
 */

public class MinusExpressionProxy extends ArithmeticBinaryExpressionProxy {
   ...
   */
  public MinusExpressionProxy(final SimpleExpressionProxy left,
  ...
  /**
   * Creates a subtraction expression from a parsed XML structure.
   ...
   *                     inconsistencies.
   */
  MinusExpressionProxy(final BinaryExpressionType expr,
  ...
  private static class Operator implements BinaryOperator {
      ...
      throws ModelException
    {
      ...
      return new MinusExpressionProxy(binary, factory);
    }
    ...
    public AbstractBinaryExpressionProxy createExpression
      (final SimpleExpressionProxy left,
       final SimpleExpressionProxy right)
    {
      return new MinusExpressionProxy(left, right);
    }

    public String getName()
    {
      return OperatorTable.OPNAME_MINUS;
    }
