...
//# CLASS:   EditorSurface
//###########################################################################
//# $Id: EditorSurface.java,v 1.56 2006-07-20 02:28:37 robi Exp $
//###########################################################################
			   ...
			   Renderable
{
  ...
  public static int CANTDROP = 2;
    ...
    return new RenderingInformation(false, false,
			EditorColor.getColor(o, NOTDRAG, false, false, false),
			EditorColor.getShadowColor(o, NOTDRAG, false, false, false),
      getPriority(o));
	}
