...
//# CLASS:   EditorSurface
//###########################################################################
//# $Id: EditorSurface.java,v 1.1 2005-02-17 01:43:35 knut Exp $
//###########################################################################
 ...
 * @author Gian Perrone
 */
public class EditorSurface extends JComponent {
	...
	ArrayList unloadedEdges = new ArrayList();
	    ...
	    int x = 0;
	    int y = 0;
	    for (y = gridSize - EditorNode.WIDTH/2; y < getHeight(); y += gridSize){
		for (x = gridSize - EditorNode.WIDTH/2; x < getWidth(); x += gridSize){
