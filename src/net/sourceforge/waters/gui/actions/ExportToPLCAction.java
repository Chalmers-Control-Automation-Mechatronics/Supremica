...
public class ExportToPLCAction extends WatersAction {

      public ExportToPLCAction(final IDE ide) {
        super(ide);
        putValue(Action.NAME, "Export to PLC");
        putValue(Action.SHORT_DESCRIPTION, "Convert the current Supremica model to a PLC script natively");
      }
      ...
      public static class LuaLogger {
          public void info(final String message, final int level) {
              System.out.println("[PLC Export] " + message);
          }
      }
      ...
      public void actionPerformed(final ActionEvent e) {
        ...
        try {
            ...
            // 3. Load the Lua script from your Eclipse 'src/scripts/' folder
            //final java.io.InputStream luaStream = getClass().getResourceAsStream("/scripts/Supremica2PLC.lua");
            try {
              luaStream = new java.io.FileInputStream("scripts/Supremica2PLC.lua");
              // Your code to execute the Lua script goes here
