...
class EditorColor
{
	...
	public static Color ERRORSHADOWCOLOR = new Color(255,0,0,32); 

	public static Color SELECTCOLOR = Color.BLUE; 
	public static Color SELECTSHADOWCOLOR = new Color(0,0,255,32); 

	public static Color HIGHLIGHTCOLOR = Color.CYAN; 
	public static Color HIGHLIGHTSHADOWCOLOR = new Color(0,255,255,32); 

	public static Color DEFAULTCOLOR = Color.BLACK; 
	public static Color DEFAULTSHADOWCOLOR = new Color(0,0,0,32); 
	public static Color DEFAULTCOLOR_NODEGROUP = Color.lightGray; 
	public static Color DEFAULTSHADOWCOLOR_NODEGROUP = new Color(0,0,0,16); 
