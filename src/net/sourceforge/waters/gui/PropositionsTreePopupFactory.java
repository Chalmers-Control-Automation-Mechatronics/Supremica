...
class PropositionsTreePopupFactory
  extends PopupFactory
{

  //#########################################################################
  //# Constructor
  PropositionsTreePopupFactory(final WatersPopupActionManager master,
                             final ModuleContext context)
  {
    super(master);
    mVisitor = new PropositionsTreePopupVisitor();
    mContext = context;
  }
  ...
  //#########################################################################
  //# Inner Class PropositionsTreePopupVisitor
  private class PropositionsTreePopupVisitor
  ...
  //#######################################################################
  //# Data Members
  private final PropositionsTreePopupVisitor mVisitor;
