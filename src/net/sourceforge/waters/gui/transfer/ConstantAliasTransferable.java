...
public class ConstantAliasTransferable extends ProxyTransferable<Proxy>
{
   ...
   */
  public ConstantAliasTransferable(final Proxy data)
  {
    super(WatersDataFlavor.CONSTANT_ALIAS_LIST, data);
  }

  /**
   * Creates a transferable that holds a whole list of event declarations.
   */
  public ConstantAliasTransferable(final List<? extends Proxy> data)
  {
    super(WatersDataFlavor.CONSTANT_ALIAS_LIST, data);
  }
