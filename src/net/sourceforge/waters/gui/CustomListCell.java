...
//###########################################################################
//# $Id: CustomListCell.java,v 1.1 2005-02-17 01:43:35 knut Exp $
//###########################################################################
...
class CustomListCell extends JLabel implements ListCellRenderer {
                                                  ...
                                                  boolean cellHasFocus)    // the list and the cell have the focus
    {
        ...
        setIcon((value.getClass().getName().endsWith("SimpleComponentProxy")) ? longIcon : shortIcon);
        if (isSelected) {
