...
public class ModuleTree extends JTree
{
                    ...
                    final ActionListener popuplistener)
  {
    ...
    if (mModule != null) {
      ...
      mRootNode = new DefaultMutableTreeNode
        (new ComponentInfo("Module: " + mModule.getName(), mModule));
    } else {
      l = new ArrayList();
      mRootNode = null;
    }
        ...
        public void mouseClicked(MouseEvent e)
        {
          if (e.getClickCount() == 2) {
            ...
            if (component instanceof VariableSubject) {
              EditorEditVariableDialog.showDialog
                ((VariableSubject) component,
        ...
        public void mousePressed(MouseEvent e)
        {
          ...
          if (selRow != -1) {
            if (e.getClickCount() == 2) {
              ...
              Object nodeInfo = node.getUserObject();
              AbstractSubject abstractComponent =
                (((ComponentInfo) nodeInfo).getComponent());
              if (abstractComponent instanceof SimpleComponentSubject) {
                SimpleComponentSubject scp =
                  (SimpleComponentSubject) abstractComponent;
  ...
  public void addVariable(VariableSubject variable)
  {
    ...
    if(((ComponentInfo) parentNode.getUserObject()).getComponent()
      ...
      addObject((DefaultMutableTreeNode) parentNode.getParent(),
                v.getUserObject(), true);
    } else {
  ...
  public void addComponent(AbstractSubject o)
  {
    if (mModule != null) {
      ...
      if (!(ci.getComponent() instanceof ForeachSubject) &&
          !(o instanceof ParameterBindingSubject)) {
        parentNode = mRootNode;
      }
      if (!(ci.getComponent() instanceof InstanceSubject) &&
          (o instanceof ParameterBindingSubject)) {
        return;
      }
      ...
      DefaultMutableTreeNode newChild =
        makeTreeFromComponent((AbstractSubject) o);
      ((DefaultTreeModel) treeModel).insertNodeInto
        (newChild, parentNode, treeModel.getChildCount(parentNode));
  ...
  public void updateSelectedNode()
  {
    ...
    DefaultMutableTreeNode node = (DefaultMutableTreeNode)
      selPath.getLastPathComponent();
    AbstractSubject c = ((ComponentInfo) node.getUserObject()).getComponent();
