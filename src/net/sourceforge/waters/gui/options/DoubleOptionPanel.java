...
class DoubleOptionPanel
  extends OptionPanel<Double>
{
  //#########################################################################
  //# Constructors
  DoubleOptionPanel(final GUIOptionContext context,
  ...
  //# Simple Access
  @Override
  DoubleInputCell getEntryComponent()
  {
    return (DoubleInputCell) super.getEntryComponent();
  }
  ...
  {
    return (DoubleOption) super.getOption();
  }
  ...
  @Override
  DoubleInputCell createEntryComponent()
  {
    final DoubleOption option = getOption();
