...
public class EFSMCreationExample
{
  public static void main(final String[] args)
  {
    ...
    // Next, two variables and an EFSM ...
   ...
   final EdgeProxy edge2 =
      factory.createEdgeProxy(state0, state1, labelBlock2, null,
                              null, null, null);
    edges.add(edge2);
    ...
    // Save to EFSMCreationExample.wmod (in current directory)
    MarshallingTools.saveModule(module, moduleName + ".wmod");
    ...
    try {
      ...
      // Save output to EFSMCreationExample.wdes (in current directory)
      MarshallingTools.saveProductDES(des, moduleName + ".wdes");
