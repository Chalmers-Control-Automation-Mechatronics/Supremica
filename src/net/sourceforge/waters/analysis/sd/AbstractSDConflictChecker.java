...
abstract public class AbstractSDConflictChecker
  extends AbstractConflictChecker
{

  //#########################################################################
  //# Constructors
  public AbstractSDConflictChecker(final ProductDESProxyFactory factory)
  {
    this(null, factory);
  }

  public AbstractSDConflictChecker(final ConflictChecker checker,
