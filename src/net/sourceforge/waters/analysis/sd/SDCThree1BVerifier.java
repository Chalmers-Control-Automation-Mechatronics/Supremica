...
/**
 * <P>A model verifier to check SD Controllability Property III.1b.</P>
 *
...
public class SDCThree1BVerifier extends AbstractSDLanguageInclusionChecker
{

  //#########################################################################
  //# Constructors
  public SDCThree1BVerifier(final ProductDESProxyFactory factory)
  {
    super(factory);
  }

  public SDCThree1BVerifier(final LanguageInclusionChecker checker,
    ...
    try {
      ...
      for (final EventProxy hib : hibs) {
        ...
        final ProductDESProxy convertedModel =
          builder.createSDThree_bModel(hib);
