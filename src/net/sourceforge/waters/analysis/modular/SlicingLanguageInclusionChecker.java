...
/**
 * <P>A modular language inclusion check algorithms that uses one
 * event at a time.</P>
 *
 * <P><I>Reference:</I><BR>
...
public class SlicingLanguageInclusionChecker
  ...
  implements LanguageInclusionChecker
{
  ...
  //#########################################################################
  //# Constructors
  public SlicingLanguageInclusionChecker(final ProductDESProxyFactory factory,
                                         final LanguageInclusionChecker nested)
  {
    this(null, factory, nested);
  }

  public SlicingLanguageInclusionChecker(final ProductDESProxy model,
