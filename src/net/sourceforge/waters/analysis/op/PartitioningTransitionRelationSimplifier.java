...
//# CLASS:   PartitioningTransitionRelationSimplifier
//###########################################################################
//# $Id$
//###########################################################################
...
public class PartitioningTransitionRelationSimplifier
  // implements TransitionRelationSimplifier
{
   ...
   * relation.
   */
  public PartitioningTransitionRelationSimplifier
    ...
    throws OverflowException
  {
    ...
    final TransitionIterator iter =
      mTransitionRelation.createPredecessorsIterator();
    ...
    implements TransitionIterator
  {
    ...
    {
      mTauPreds =
        PartitioningTransitionRelationSimplifier.this.mTauPreds[mTarget];
      mIndex = -1;
    }
    ...
    implements TransitionIterator
  {
    ...
    {
      mInnerIterator = mTransitionRelation.createPredecessorsIterator();
