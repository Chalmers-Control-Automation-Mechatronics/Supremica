  ...
  implements ControlLoopChecker
{
  ...
  private void setup()
  {
    ...
    mEncodedInitialStateTuple =
      new EncodedStateTuple(encoding(mInitialStateTuple));
   ...
   */
  private void visit(EncodedStateTuple encodedCurrTuple)
  {
    ...
    decoding(encodedCurrTuple.getCodes(), currTuple);
      ...
      if (eventAvailable(currTuple, i)) {
        if (mGlobalEventMap[i]) { // CONTROLLABLE
          EncodedStateTuple encodedNextTuple =
            new EncodedStateTuple(encoding(mNextTuple));
   ...
   */
  private boolean eventAvailable(int currTuple[], int event)
  {
    int temp;
   ...
   */
  private int getBitLength(AutomatonProxy automaton)
  {
   ...
   */
  private int[] encoding(final int[] stateCodes)
  {
   ...
   */
  private void decoding(final int[] encodedStateCodes, final int[] currTuple)
  {
