  ...
  extends AbstractModelAnalyzerFactory
{
  ...
  */
    ...
    extends CommandLineArgumentString
  {
    ...
    public void configure(final ModelAnalyzer analyzer)
    {
      ...
      final TRCompositionalConflictChecker composer =
        (TRCompositionalConflictChecker) analyzer;
      final EnumFactory<TRCompositionalConflictChecker.PreselectingMethod>
        factory = composer.getPreselectingMethodFactory();
      final TRCompositionalConflictChecker.PreselectingMethod method =
  ...
  */
    ...
    extends CommandLineArgumentBoolean
  {
    ...
    {
      final TRCompositionalConflictChecker composer =
        (TRCompositionalConflictChecker) verifier;
      final boolean enable = getValue();
