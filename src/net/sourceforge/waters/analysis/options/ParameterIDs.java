...
public class ParameterIDs
{
  ...
  public static final int ModelAnalyzer_KindTranslator_ID = 1;                     //Unused
  public static final int ModelAnalyzer_NodeLimit_ID = 2;
  public static final int ModelAnalyzer_TransitionLimit_ID = 3;
  ...
  public static final int ModelBuilder_OutputName_ID = 100;

  public static final StringParameter ModelBuilder_OutputName =   new StringParameter
    (ModelBuilder_OutputName_ID,
     "Supervisor name prefix",
     "Name or name prefix for synthesised supervisors.",
     "Supervisor");     //getOutputName()

  //net.sourceforge.waters.model.analysis.SupervisorSynthesizer
  public static final int SupervisorSynthesizer_ControllableSynthesis_ID = 200;
  public static final int SupervisorSynthesizer_NonblockingSynthesis_ID = 201;
  public static final int SupervisorSynthesizer_NormalSynthesis_ID = 202;                          //Unused
  public static final int SupervisorSynthesizer_ConfiguredDefaultMarking_ID = 203;
  public static final int SupervisorSynthesizer_SupervisorLocalisationEnabled_ID = 204;
  public static final int SupervisorSynthesizer_SupervisorReductionFactory_ID = 205;
  public static final int SupervisorSynthesizer_Supremica_SupervisorReductionFactory_ID = 206;
  public static final int SupervisorSynthesizer_SupervisorNamePrefix_ID = 207;                       //Unused

  public static final BoolParameter SupervisorSynthesizer_ControllableSynthesis = new BoolParameter
    (SupervisorSynthesizer_ControllableSynthesis_ID,
     "Controllable supervisor",
     "Synthesise a controllable supervisor.",
     true);

  public static final BoolParameter SupervisorSynthesizer_NonblockingSynthesis = new BoolParameter
  ...
  public static final EventParameter SupervisorSynthesizer_ConfiguredDefaultMarking =
    new EventParameter(SupervisorSynthesizer_ConfiguredDefaultMarking_ID,
                       "Marking proposition",
  ...
  public static final BoolParameter SupervisorSynthesizer_SupervisorLocalisationEnabled =   new BoolParameter
  ...
  public static final EnumParameter<SupervisorReductionFactory> SupervisorSynthesizer_SupervisorReductionFactory =
    new EnumParameter<SupervisorReductionFactory>(SupervisorSynthesizer_SupervisorReductionFactory_ID,
                                                  "Supervisor reduction",
                                                  "Method of supervisor reduction to be used after synthesis");

  public static final EnumParameter<SupervisorReductionFactory> SupervisorSynthesizer_Supremica_SupervisorReductionFactory =
    new EnumParameter<SupervisorReductionFactory>(SupervisorSynthesizer_Supremica_SupervisorReductionFactory_ID,
                                                  "Supervisor reduction",
                                                  "Method of supervisor reduction to be used after synthesis");
  ...
  public static final int AbstractCompositionalModelAnalyzer_AbstractionProcedureCreator_ID = 500;
  public static final int AbstractCompositionalModelAnalyzer_BlockedEventsEnabled_ID = 501;
  public static final int AbstractCompositionalModelAnalyzer_FailingEventsEnabled_ID = 504;
  public static final int AbstractCompositionalModelAnalyzer_InternalStateLimit_ID = 505;
  public static final int AbstractCompositionalModelAnalyzer_InternalTransitionLimit_ID = 506;
  public static final int AbstractCompositionalModelAnalyzer_LowerInternalStateLimit_ID = 507;             //unused
  public static final int AbstractCompositionalModelAnalyzer_MonolithicAnalyzer_ID = 508;                    //unused
  public static final int AbstractCompositionalModelAnalyzer_MonolithicDumpFile_ID = 509;
  public static final int AbstractCompositionalModelAnalyzer_MonolithicStatelimit_ID = 510;
  public static final int AbstractCompositionalModelAnalyzer_MonolithicTransitionLimit_ID = 511;
  public static final int AbstractCompositionalModelAnalyzer_PreselectingMethod_ID = 512;
  public static final int AbstractCompositionalModelAnalyzer_PruningDeadlocks_ID = 513;
  public static final int AbstractCompositionalModelAnalyzer_SelectionHeurisitc_ID = 514;
  public static final int AbstractCompositionalModelAnalyzer_SelfLoopOnlyEventsEnabled_ID = 515;
  public static final int AbstractCompositionalModelAnalyzer_SubumptionEnabled_ID = 516;
  public static final int AbstractCompositionalModelAnalyzer_SynchronousProductBuilder_ID = 517;         //unused
  public static final int AbstractCompositionalModelAnalyzer_UpperInternalStateLimit_ID = 518;           //unused
  public static final int AbstractCompositionalModelAnalyzer_UsingSpecialEvents_ID = 519;                //unused
  ...
  public static final EnumParameter<AbstractionProcedureCreator> AbstractCompositionalModelAnalyzer_AbstractionProcedureCreator =
    new EnumParameter<AbstractionProcedureCreator>(AbstractCompositionalModelAnalyzer_AbstractionProcedureCreator_ID,
                                                   "Abstraction procedure",
                                                   "Abstraction procedure to simplify automata during compositional "
                                                                            + "minimisation.");

  public static final BoolParameter AbstractCompositionalModelAnalyzer_BlockedEventsEnabled = new BoolParameter
    (AbstractCompositionalModelAnalyzer_BlockedEventsEnabled_ID,
     "Use blocked events",
     "Detect and remove events known to be globablly disabled.",
     true);

  public static final BoolParameter AbstractCompositionalModelAnalyzer_FailingEventsEnabled = new BoolParameter
  ...
  public static final IntParameter AbstractCompositionalModelAnalyzer_InternalStateLimit = new IntParameter
  ...
  public static final IntParameter AbstractCompositionalModelAnalyzer_InternalTransitionLimit = new IntParameter
  ...
  public static final FileParameter AbstractCompositionalModelAnalyzer_MonolithicDumpFile =  new FileParameter
  ...
  public static final IntParameter AbstractCompositionalModelAnalyzer_MonolithicStatelimit =  new IntParameter
  ...
  public static final IntParameter AbstractCompositionalModelAnalyzer_MonolithicTransitionLimit = new IntParameter
  ...
  public static final EnumParameter<PreselectingMethod> AbstractCompositionalModelAnalyzer_PreselectingMethod = new EnumParameter<PreselectingMethod>
  (AbstractCompositionalModelAnalyzer_PreselectingMethod_ID,
    "Preselection method",
    "Preselection heuristic to choose groups of automata to consider " +
    "for composition.");

 public static final BoolParameter AbstractCompositionalModelAnalyzer_PruningDeadlocks =  new BoolParameter
 (AbstractCompositionalModelAnalyzer_PruningDeadlocks_ID,
  ...
  public static final EnumParameter<SelectionHeuristicCreator> AbstractCompositionalModelAnalyzer_SelectionHeurisitc =
    new EnumParameter<SelectionHeuristicCreator>(AbstractCompositionalModelAnalyzer_SelectionHeurisitc_ID,
                                                 "Selection heuristic",
                                                 "Heuristic to choose the group of automata to compose and simplify "
                                                                        + "from the options produced by the preselection method.");

public static final BoolParameter AbstractCompositionalModelAnalyzer_SelfLoopOnlyEventsEnabled = new BoolParameter
...
public static final BoolParameter AbstractCompositionalModelAnalyzer_SubumptionEnabled = new BoolParameter
(AbstractCompositionalModelAnalyzer_SubumptionEnabled_ID,
 ...
 true);
  ...
  public static final int ModularControllabilitySynthesizer_IncludesAllAutomata_ID = 600;                  //unused
  public static final int ModularControllabilitySynthesizer_LocalNonblockingSupported_ID = 601;            //unused
  public static final int ModularControllabilitySynthesizer_RemovesUnnecessarySupervisors_ID = 602;

  public static BoolParameter ModularControllabilitySynthesizer_RemovesUnnecessarySupervisors = new BoolParameter
  (ModularControllabilitySynthesizer_RemovesUnnecessarySupervisors_ID,
 ...
 //net.sourceforge.waters.model.analysis.ConflictChecker
  ...
  public static final int ModelVerifier_CounterExampleEnabled_ID = 800;                //unused
  public static final int ModelVerifier_ShortCounterExampleRequested_ID = 801;


  public static final BoolParameter ModelVerifier_ShortCounterExampleRequested = new BoolParameter
  ...
  public static final int BDDModelVerifier_BDDPackage_ID = 900;
  public static final int BDDModelVerifier_InitialSize_ID = 901;
  public static final int BDDModelVerifier_PartitionSizeLimit_ID = 902;
  public static final int BDDModelVerifier_ReorderingEnabled_ID = 903;
  public static final int BDDModelVerifier_TransactionPartitioningStrategy_ID = 904;
  public static final int BDDModelVerifier_VariableOrdering_ID = 905;

  public static final EnumParameter<BDDPackage> BDDModelVerifier_BDDPackage = new EnumParameter<BDDPackage>
  (BDDModelVerifier_BDDPackage_ID,
    "BDD package",
    "The BDD package used when running the algorithm",
    BDDPackage.values());

  public static final IntParameter BDDModelVerifier_InitialSize = new IntParameter
  ...
  public static final IntParameter BDDModelVerifier_PartitionSizeLimit = new IntParameter
  ...
  public static final BoolParameter BDDModelVerifier_ReorderingEnabled = new BoolParameter
  ...
  public static final EnumParameter<TransitionPartitioningStrategy> BDDModelVerifier_TransactionPartitioningStrategy =
    new EnumParameter<TransitionPartitioningStrategy>(BDDModelVerifier_TransactionPartitioningStrategy_ID,
  ...
  public static final EnumParameter<VariableOrdering> BDDModelVerifier_VariableOrdering =
    new EnumParameter<VariableOrdering>(BDDModelVerifier_VariableOrdering_ID,
  ...
  public static final int AbstractCompositionalModelVerifier_TraceCheckingEnabled_ID = 1000;

  public static final BoolParameter AbstractCompositionalModelVerifier_TraceCheckingEnabled = new BoolParameter
  ...
  public static final int NativeConflictChecker_ConflictCheckMode_ID = 1100;

  public static final EnumParameter<ConflictCheckMode> NativeConflictChecker_ConflictCheckMode =
    new EnumParameter<ConflictCheckMode>(NativeConflictChecker_ConflictCheckMode_ID,
                                         "Conflict check mode",
  ...
  public static final int AbstractTRCompositionalModelAnalyzer_PreselectionHeuristic_ID = 1200;
  public static final int AbstractTRCompositionalModelAnalyzer_SelectionHeuristic_ID = 1201;
  public static final int AbstractTRCompositionalModelAnalyzer_SimplifierCreator_ID = 1202;
  public static final int AbstractTRCompositionalModelAnalyzer_AlwaysEnabledEventsEnabled_ID = 1203;

  public static final EnumParameter<TRPreselectionHeuristic> AbstractTRCompositionalModelAnalyzer_PreselectionHeuristic = new EnumParameter<TRPreselectionHeuristic>
  ...
  public static final BoolParameter AbstractTRCompositionalModelAnalyzer_AlwaysEnabledEventsEnabled = new BoolParameter
  ...
  public static final int CompositionalGeneralisedConflictChecker_PreselectingHeuristic_ID = 1300;
  public static final int CompositionalGeneralisedConflictChecker_SelectingHeuristic_ID = 1301;

  public static final EnumParameter<CompositionalGeneralisedConflictChecker.PreselectingHeuristic> CompositionalGeneralisedConflictChecker_PreselectingHeuristic =
    new EnumParameter<CompositionalGeneralisedConflictChecker.PreselectingHeuristic>
  (CompositionalGeneralisedConflictChecker_PreselectingHeuristic_ID,
    "Preselection method",
    "Preselection heuristic to generate groups of automata to consider " +
    "for composition.");

  public static final EnumParameter<CompositionalGeneralisedConflictChecker.SelectingHeuristic> CompositionalGeneralisedConflictChecker_SelectingHeuristic =
    new EnumParameter<CompositionalGeneralisedConflictChecker.SelectingHeuristic>
  ...
  public static final int AutomatonBuilder_OutputKind_ID = 1400;
  ...
  public static final BoolParameter SynchronousProductBuilder_RemovingSelfloops = new BoolParameter
  ...
  public static final int MonolithicSynchronousProductBuilder_PruningDeadlocks_ID = 1600;

  public static final BoolParameter MonolithicSynchronousProductBuilder_PruningDeadlocks = new BoolParameter
    (MonolithicSynchronousProductBuilder_PruningDeadlocks_ID,
     "Prune deadlocks",
     "Stop synchronous product construction when encountering " +
     "states that are a deadlock in one of the components.",
     true); //isPruningDeadlocks());

  //net.sourceforge.waters.analysis.monolithic.TRAbstractModelAnalyzer
  public static final int TRAbstractModelAnalyzer_PruningDeadLocks_ID = 1700;

  public static final BoolParameter TRAbstractModelAnalyzer_PruningDeadLocks = new BoolParameter
    (TRAbstractModelAnalyzer_PruningDeadLocks_ID,
     "Prune deadlocks",
     "Stop synchronous product construction when encountering " +
     "states that are a deadlock in one of the components.",
     true); //isPruningDeadlocks());
  ...
  public static final int SupremicaModelAnalyzer_EnsuringUncontrollablesInPlant_ID = 5000;

  public static final BoolParameter SupremicaModelAnalyzer_EnsuringUncontrollablesInPlant = new BoolParameter
    (SupremicaModelAnalyzer_EnsuringUncontrollablesInPlant_ID,
     ...
     true); //isEnsuringUncontrollablesInPlant());

  //org.supremica.automata.waters.SupremicaSynchronousProductBuilder
  public static final int SupremicaSynchronousProductBuilder_ShortStateNames_ID = 5100;
  public static final int SupremicaSynchronousProductBuilder_StateNameSeparator_ID = 5101;
  public static final int SupremicaSynchronousProductBuilder_MarkingUncontrollableStatesAsForbidden_ID = 5102;
  public static final int SupremicaSynchronousProductBuilder_ExpandingForbiddenStates_ID = 5103;
  public static final int SupremicaSynchronousProductBuilder_RememberingDisabledEvents_ID = 5104;
  public static final int SupremicaSynchronousProductBuilder_SynchronisingOnUnobservableEvents_ID = 5105;

  public static final BoolParameter SupremicaSynchronousProductBuilder_ShortStateNames = new BoolParameter
    (SupremicaSynchronousProductBuilder_ShortStateNames_ID,
     "Short state names",
     "Use short state instead of detailed state tuple information.",
     true); //isUsingShortStateNames());

  public static final StringParameter SupremicaSynchronousProductBuilder_StateNameSeparator = new StringParameter
  ...
  public static final BoolParameter SupremicaSynchronousProductBuilder_MarkingUncontrollableStatesAsForbidden = new BoolParameter
    (SupremicaSynchronousProductBuilder_MarkingUncontrollableStatesAsForbidden_ID,
     ...
     true);     //isMarkingUncontrollableStatesAsForbidden();

  public static final BoolParameter SupremicaSynchronousProductBuilder_ExpandingForbiddenStates = new BoolParameter
    (SupremicaSynchronousProductBuilder_ExpandingForbiddenStates_ID,
     ...
     true); //isExpandingForbiddenStates();

  public static final BoolParameter SupremicaSynchronousProductBuilder_RememberingDisabledEvents = new BoolParameter
    (SupremicaSynchronousProductBuilder_RememberingDisabledEvents_ID,
     ...
     true); //isRememberingDisabledEvents());

  public static final BoolParameter SupremicaSynchronousProductBuilder_SynchronisingOnUnobservableEvents = new BoolParameter
    (SupremicaSynchronousProductBuilder_SynchronisingOnUnobservableEvents_ID,
     ...
     true); //isSynchronisingOnUnobservableEvents();

  //org.supremica.automata.waters.SupremicaSynthesizer
  public static final int SupremicaSynthesizer_Purging_ID = 5200;

  public static final BoolParameter SupremicaSynthesizer_Purging = new BoolParameter
