...
public class SimplifierCreatorOption extends SelectorOption<AutomatonSimplifierCreator>
{
  public SimplifierCreatorOption
    (final String id,
     final List<AutomatonSimplifierCreator> keys,
     final AutomatonSimplifierCreator defaultKey) {
    super(id, "Simplifier", keys, defaultKey);
  }

  @Override
  public String getDescription(final Object key)
  {
    return ((AutomatonSimplifierCreator) key).getDescription();
  }
