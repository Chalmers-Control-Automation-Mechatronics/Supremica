...
public class EnabledEventsSetSilentIncomingTRSimplifier
  extends AbstractMarkingTRSimplifier
{

  //#########################################################################
  //# Constructors
  public EnabledEventsSetSilentIncomingTRSimplifier()
  {
  }

  public EnabledEventsSetSilentIncomingTRSimplifier(final ListBufferTransitionRelation rel)
  {
    super(rel);
  }
   ...
   * It is also reducible if some of the set of outgoing events are always enabled
   *
   * @throws OverflowException
   */
  private boolean isReducible(final int state) throws OverflowException
  {
