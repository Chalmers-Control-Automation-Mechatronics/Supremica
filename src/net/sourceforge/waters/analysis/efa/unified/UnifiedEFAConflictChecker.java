  ...
  implements ArgumentSource
{
  ...
  public void setOption(final Option<?> option)
  {
    if (option.hasID(UnifiedEFACommandLineTool.
      ...
      final EnumOption<UnifiedEFASimplifierFactory> opt =
        (EnumOption<UnifiedEFASimplifierFactory>) option;
      final UnifiedEFASimplifierFactory factory = opt.getValue();
      setSimplifierFactory(factory);
    } else if (option.hasID(UnifiedEFACommandLineTool.
                            OPTION_UnifiedEFACommandLineTool_InternalStateLimit)) {
      final PositiveIntOption opt = (PositiveIntOption) option;
      setInternalStateLimit(opt.getValue());
    } else if (option.hasID(UnifiedEFACommandLineTool.
                            OPTION_UnifiedEFACommandLineTool_InternalTransitionLimit)) {
      final PositiveIntOption opt = (PositiveIntOption) option;
      setInternalTransitionLimit(opt.getValue());
    } else if (option.hasID(UnifiedEFACommandLineTool.
                     OPTION_UnifiedEFACommandLineTool_CompositionSelectionHeuristic)) {
      @SuppressWarnings("unchecked")
      final Option<SelectionHeuristic<UnifiedEFACandidate>> opt =
        (Option<SelectionHeuristic<UnifiedEFACandidate>>) option;
      ...
      final SelectionHeuristic<UnifiedEFAVariable> heuristic = opt.getValue();
