...
public class EFASimplifierStatistics
{
  ...
  public void recordStart(final EFSMTransitionRelation efsmTR1,
  ...
  public void recordStart(final EFSMVariable var)
  {
    mApplicationCount++;
    if (mInputStates >= 0) {
  ...
  public void recordFinish(final EFSMTransitionRelation efsmTR,
