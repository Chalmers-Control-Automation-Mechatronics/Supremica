...
/**
 * This transition relation implementation is deprecated. Please use
 * {@link net.sourceforge.waters.analysis.tr.ListBufferTransitionRelation}
 * instead.
 *
 * @author Simon Ware, Robi Malik
 */

public class OldTransitionRelation
{
   ...
   */
  public OldTransitionRelation(final AutomatonProxy aut)
  {
    this(aut, null);
  }
