...
public class PromelaNode
{
  ...
  public SimpleNodeProxy createNode(final String name,final int index,final boolean init,final boolean initial,final boolean marked,final ModuleProxyFactory factory){
    ...
    if(marked){
      ...
      if(init){
        mNode = factory.createSimpleNodeProxy(name+":"+index, eventList, initial, null, null, null);
      }else{
      ...
      if(init){
      mNode = factory.createSimpleNodeProxy(name+":"+index, null, initial, null, null, null);
      }
      else{
