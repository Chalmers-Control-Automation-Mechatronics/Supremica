...
/**
 * An immutable implementation of the {@link NestedBlockProxy} interface.
 *
 * @author Robi Malik
 */

public abstract class NestedBlockElement
  extends Element
  implements NestedBlockProxy
{
   ...
   */
  protected NestedBlockElement(final Collection<? extends Proxy> body)
  {
    if (body == null) {
  ...
  //# Cloning
  @Override
  public NestedBlockElement clone()
  {
    return (NestedBlockElement) super.clone();
  }
  ...
  //#########################################################################
  //# Class Constants
  private static final long serialVersionUID = 4294011739408451041L;
