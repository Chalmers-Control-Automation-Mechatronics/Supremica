...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>sag</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class SagExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.sag"));
				Graph root = SagFactory.eINSTANCE.createGraph();
