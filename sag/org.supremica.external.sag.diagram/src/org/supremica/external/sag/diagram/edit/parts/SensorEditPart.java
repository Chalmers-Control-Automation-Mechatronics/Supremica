...
public class SensorEditPart extends ShapeNodeEditPart {
	...
	protected IFigure createNodeShape() {
		SensorNodeFigure figure = new SensorNodeFigure();
	 ...
	 * @generated
	 */
	public SensorNodeFigure getPrimaryShape() {
		return (SensorNodeFigure) primaryShape;
	}
	 ...
	 * @generated
	 */
	public class SensorNodeFigure extends Ellipse {
		/**
		 * @generated
		 */
		public SensorNodeFigure() {
		...
		private void createContents() {
			...
			WrapLabel sensorNameFigure0 = new WrapLabel();
			sensorNameFigure0.setText("<...>");

			this.add(sensorNameFigure0, BorderLayout.CENTER);
		 ...
		 * @generated
		 */
		private WrapLabel fSensorNameFigure;

		/**
		 * @generated
		 */
		public WrapLabel getFigureSensorNameFigure() {
		 ...
		 * @generated
		 */
		private void setFigureSensorNameFigure(WrapLabel fig) {
