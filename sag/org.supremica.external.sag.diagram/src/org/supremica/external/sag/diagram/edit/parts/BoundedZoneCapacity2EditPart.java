...
import org.supremica.external.sag.diagram.edit.policies.SagTextSelectionEditPolicy;
 ...
 * @generated
 */
public class BoundedZoneCapacity2EditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(SagVisualIDRegistry
				.getType(BoundedZoneCapacity2EditPart.VISUAL_ID), new Point(0,
				40));
	}
	 ...
	 * @generated
	 */
	public BoundedZoneCapacity2EditPart(View view) {
		super(view);
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, TextDirectEditManager
					.getTextCellEditorClass(this), SagEditPartFactory
