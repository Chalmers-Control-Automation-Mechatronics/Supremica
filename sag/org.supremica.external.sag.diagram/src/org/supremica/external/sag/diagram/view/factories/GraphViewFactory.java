package org.supremica.external.sag.diagram.view.factories;
 ...
 * @generated
 */
public class GraphViewFactory extends AbstractShapeViewFactory {
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = SagVisualIDRegistry
					.getType(org.supremica.external.sag.diagram.edit.parts.GraphEditPart.VISUAL_ID);
			view.setType(semanticHint);
		}
		super.decorateView(containerView, view, semanticAdapter, semanticHint,
				index, persisted);
		if (!ProjectEditPart.MODEL_ID.equals(SagVisualIDRegistry
		...
		getViewService().createNode(semanticAdapter, view,
				SagVisualIDRegistry.getType(GraphNameEditPart.VISUAL_ID),
