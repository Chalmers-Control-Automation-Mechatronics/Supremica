package org.supremica.external.sag.diagram.expressions;
 ...
 * @generated
 */
public abstract class SagAbstractExpression {
	/**
	 * @generated
	 */
	private static final boolean DISABLED_NO_IMPL_EXCEPTION_LOG = Boolean
			.valueOf(
					Platform.getDebugOption(SagDiagramEditorPlugin
	 ...
	 * @generated
	 */
	protected SagAbstractExpression(EClassifier context) {
	 ...
	 * @generated
	 */
	protected SagAbstractExpression(String body, EClassifier context, Map env) {
		this.body = body;
		this.context = context;
		this.env = env;
	}
	...
	protected void setStatus(int severity, String message, Throwable throwable) {
		String pluginID = SagDiagramEditorPlugin.ID;
	 ...
	 * @generated
	 */
	public static final SagAbstractExpression createNullExpression(
			EClassifier context) {
		return new SagAbstractExpression(context) {
