  ...
  extends AbstractSICProperty6VerifierTest
{
    ...
    (final ProductDESProxyFactory factory)
  {
    ...
    checker.setPreselectionHeuristic(AbstractTRCompositionalModelAnalyzer.PRESEL_MaxS);
    checker.setSelectionHeuristic(AbstractTRCompositionalModelAnalyzer.SEL_MinE);
