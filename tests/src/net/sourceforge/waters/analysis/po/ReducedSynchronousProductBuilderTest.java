...
public class ReducedSynchronousProductBuilderTest
  extends AbstractSynchronousProductBuilderTest
{
  ...
  public static Test suite() {
    final TestSuite testSuite =
      new TestSuite(ReducedSynchronousProductBuilderTest.class);
    return testSuite;
  }
  ...
  @Override
  protected ReducedSynchronousProductBuilder
    createAutomatonBuilder(final ProductDESProxyFactory factory)
  {
    return new ReducedSynchronousProductBuilder(factory);
  }

  @Override
  protected ReducedSynchronousProductBuilder getAutomatonBuilder()
  {
    return (ReducedSynchronousProductBuilder) super.getAutomatonBuilder();
  }
  ...
  protected void configureAutomatonBuilder(final ProductDESProxy des)
  {
    ...
    final ReducedSynchronousProductBuilder builder = getAutomatonBuilder();
