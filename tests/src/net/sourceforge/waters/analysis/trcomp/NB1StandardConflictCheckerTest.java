...
//# CLASS:   NB1StandardConflictCheckerTest
//###########################################################################
//# $Id$
//###########################################################################
...
public class NB1StandardConflictCheckerTest
  extends AbstractStandardConflictCheckerTest
{
  ...
  public static Test suite()
  {
    final TestSuite testSuite =
      new TestSuite(NB1StandardConflictCheckerTest.class);
    return testSuite;
  }
    ...
    (final ProductDESProxyFactory factory)
  {
    ...
    checker.setSimplifierCreator(TRCompositionalConflictChecker.NB1);
    checker.setPreselectionHeuristic(AbstractTRCompositionalAnalyzer.MinT);
