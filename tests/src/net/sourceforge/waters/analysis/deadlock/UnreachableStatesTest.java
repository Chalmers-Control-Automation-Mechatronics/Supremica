  ...
  extends AbstractAnalysisTest
{
  ...
  public UnreachableStatesTest()
  {
  }

  public UnreachableStatesTest(final String name)
  {
    super(name);
  }
   ...
   */
  public void test_unreachable_states_test01() throws Exception
  {
    final ProductDESProxy des =
      getCompiledDES("tests", "deadlock_abstraction", "unreachable_states_test01.wmod");
    runTransitionRelationSimplifier(des);
  }

  public void test_unreachable_states_test02() throws Exception
  {
    final ProductDESProxy des =
      getCompiledDES("tests", "deadlock_abstraction", "unreachable_states_test02.wmod");
    runTransitionRelationSimplifier(des);
  }
