...
public class DiamondEliminatorTest extends AbstractAnalysisTest
{
  //#########################################################################
  //# Overrides for base class junit.framework.TestCase
  public DiamondEliminatorTest()
  {
  }

  public DiamondEliminatorTest(final String name)
  {
    super(name);
  }
   ...
   * </P>
   */
  public void test_diamondElimination_01() throws Exception
  {
  ...
  public void test_diamondElimination_07() throws Exception
  {
    final ProductDESProxy des =
      getCompiledDES("tests", "deadlock_abstraction",
                     "diamondElimination_07.wmod");
    runTransitionRelationSimplifier(des);
  }

  public void test_diamondElimination_08() throws Exception
  {
    final ProductDESProxy des =
      getCompiledDES("tests", "deadlock_abstraction",
                     "diamondElimination_08.wmod");
    runTransitionRelationSimplifier(des);
  }
  ...
  public void test_diamondElimination_11() throws Exception
  {
    final ProductDESProxy des =
      getCompiledDES("tests", "deadlock_abstraction",
                     "diamondElimination_11.wmod");
    runTransitionRelationSimplifier(des);
  }
