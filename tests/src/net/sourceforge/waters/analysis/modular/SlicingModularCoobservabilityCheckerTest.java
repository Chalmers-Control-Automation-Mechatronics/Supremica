...
public class SlicingModularCoobservabilityCheckerTest
  extends AbstractCoobservabilityCheckerTest
{
  ...
  public static Test suite()
  {
    final TestSuite testSuite =
      new TestSuite(SlicingModularCoobservabilityCheckerTest.class);
    return testSuite;
  }
  ...
  @Override
  protected SlicingCoobservabilityChecker createModelVerifier
    (final ProductDESProxyFactory factory)
  {
    ...
    final ModularCoobservabilityChecker modular =
      new ModularCoobservabilityChecker(factory, mono);
