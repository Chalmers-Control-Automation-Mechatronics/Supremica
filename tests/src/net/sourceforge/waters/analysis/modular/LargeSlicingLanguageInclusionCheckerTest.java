...
/**
 * A test for the one-event-at-a-time language inclusion check algorithm.
 * Test seems to pass but takes 40 minutes due to many slow PROFIsafe
 * instances, hence disabled by naming as <CODE>Large</CODE>.
 *
 * @author Robi Malik
 */

public class LargeSlicingLanguageInclusionCheckerTest
  extends AbstractLanguageInclusionCheckerTest
{
  ...
  public static Test suite()
  {
    final TestSuite testSuite =
      new TestSuite(LargeSlicingLanguageInclusionCheckerTest.class);
    return testSuite;
  }
    ...
    (final ProductDESProxyFactory factory)
  {
    ...
    final ModularLanguageInclusionChecker modular =
      new ModularLanguageInclusionChecker(factory, mono);
