...
//###########################################################################
//# $Id: MinTransitionsHeuristicTest.java,v 1.2 2006-11-17 03:38:22 robi Exp $
//###########################################################################
...
public class MinTransitionsHeuristicTest
  extends AbstractControllabilityCheckerTest
{
  ...
  public static Test suite() {
    TestSuite testSuite =
      new TestSuite(MinTransitionsHeuristicTest.class);
    return testSuite;
  }
  ...
  protected ModularControllabilityChecker createModelVerifier(final ProductDESProxyFactory factory)
  {
    return new ModularControllabilityChecker(null, factory,
                                             ...
                                             new MinTransitionsHeuristic(false));
  }
}
