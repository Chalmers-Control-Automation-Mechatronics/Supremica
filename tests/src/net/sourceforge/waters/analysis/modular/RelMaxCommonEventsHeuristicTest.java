...
//###########################################################################
//# $Id: RelMaxCommonEventsHeuristicTest.java,v 1.3 2006-12-01 02:16:43 siw4 Exp $
//###########################################################################
...
public class RelMaxCommonEventsHeuristicTest
  extends AbstractControllabilityCheckerTest
{
  ...
  public static Test suite() {
    TestSuite testSuite =
      new TestSuite(RelMaxCommonEventsHeuristicTest.class);
    return testSuite;
  }
  ...
  protected ModularControllabilityChecker createModelVerifier(final ProductDESProxyFactory factory)
  {
    return new ModularControllabilityChecker(null, factory,
                                             ...
                                             new RelMaxCommonEventsHeuristic(HeuristicType.NOPREF), false);
  }
}
