...
//###########################################################################
//# $Id: MinNewEventsHeuristicTest.java,v 1.4 2007-01-03 00:49:08 robi Exp $
//###########################################################################
...
public class MinNewEventsHeuristicTest
  extends AbstractControllabilityCheckerTest
{
  ...
  public static Test suite() {
    TestSuite testSuite =
      new TestSuite(MinNewEventsHeuristicTest.class);
    return testSuite;
  }
    ...
    (final ProductDESProxyFactory desfactory)
  {
    ...
    checker.setHeuristicMethod(ModularHeuristicFactory.Method.MinNewEvents);
    return checker;
  }
