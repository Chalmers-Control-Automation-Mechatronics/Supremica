...
//###########################################################################
//# $Id: MinEventsHeuristicTest.java,v 1.4 2007-01-03 00:49:08 robi Exp $
//###########################################################################
...
public class MinEventsHeuristicTest
  extends AbstractControllabilityCheckerTest
{
  ...
  public static Test suite() {
    TestSuite testSuite =
      new TestSuite(MinEventsHeuristicTest.class);
    return testSuite;
  }
    ...
    (final ProductDESProxyFactory desfactory)
  {
    ...
    checker.setHeuristicMethod(ModularHeuristicFactory.Method.MinEvents);
    return checker;
  }
