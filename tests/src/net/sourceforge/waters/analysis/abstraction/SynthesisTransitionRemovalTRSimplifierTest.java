  ...
  extends AbstractTRSimplifierTest
{
  ...
  public void test_synthesis_transition_removal_10() throws Exception
  {
    final String group = "tests";
    final String subdir = "abstraction";
    final String name = "synthesis_transition_removal_10.wmod";
    runTransitionRelationSimplifier(group, subdir, name);
  }

  public void test_synthesis_transition_removal_11() throws Exception
  {
    final String group = "tests";
    final String subdir = "abstraction";
    final String name = "synthesis_transition_removal_11.wmod";
    runTransitionRelationSimplifier(group, subdir, name);
  }

  public void test_synthesis_transition_removal_12() throws Exception
  {
    final String group = "tests";
    final String subdir = "abstraction";
    final String name = "synthesis_transition_removal_12.wmod";
    runTransitionRelationSimplifier(group, subdir, name);
  }
