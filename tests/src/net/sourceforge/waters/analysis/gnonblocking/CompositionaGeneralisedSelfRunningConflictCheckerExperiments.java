 ...
 */
public class CompositionaGeneralisedSelfRunningConflictCheckerExperiments
    extends CompositionalGeneralisedConflictCheckerExperiments
{

  // #######################################################################
  // # Constructor
  public CompositionaGeneralisedSelfRunningConflictCheckerExperiments(
  ...
  public static void main(final String[] args) throws Exception
  {
    if (args.length == 2) {
      ...
      System.err
          .println("Usage: CompositionalGeneralisedSelfRunningConflictCheckerExperiments outputFilename listOfRulesSelection");
    }
  }
