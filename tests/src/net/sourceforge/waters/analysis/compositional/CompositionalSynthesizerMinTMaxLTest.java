...
//# CLASS:   CompositionalSynthesizerMinTMaxLTest
//###########################################################################
//# $Id$
//###########################################################################
  ...
  extends AbstractSupervisorSynthesizerTest
{
  ...
  public static Test suite()
  {
    final TestSuite testSuite =
      new TestSuite(CompositionalSynthesizerMinTMaxLTest.class);
    return testSuite;
  }
    ...
    (final ProductDESProxyFactory factory)
  {
    ...
    synthesizer.setPreselectingMethod(AbstractCompositionalModelAnalyzer.MinT);
