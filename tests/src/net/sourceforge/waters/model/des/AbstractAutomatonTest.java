  ...
  extends TestCase
{
   ...
   * <b>state names</b> are different. Uses assertFalse() since we expect 
   * AutomationProxy.equalsByContents() to return false in this case.
   */
   ...
   * their <b>state names</b> are all different. Uses assertFalse() since we 
   * expect AutomationProxy.equalsByContents() to return false in this case.
   */
  ...
  /**
   * Tests whether two automata are equal, even if <b>some</b> of their 
   * <b>event names</b> are different. Uses assertFalse() since we expect 
   * AutomationProxy.equalsByContents() to return false in this case.
   */
  ...
  /**
   * Tests whether two automata are equal, even if <b>every one</b> of 
   * their <b>event names</b> are all different. Uses assertFalse() since we 
   * expect AutomationProxy.equalsByContents() to return false in this case.
   */
   ...
   * <b>extra state</b>. Uses assertFalse() since we expect 
   * AutomationProxy.equalsByContents() to return false in this case.
   */
  ...
  /**
   * Tests whether two automata are equal, even if one has an 
   * <b>extra event</b>. Uses assertFalse() since we expect 
   * AutomationProxy.equalsByContents() to return false in this case.
   */
  ...
  /**
   * Tests whether two automata are equal, even if one has an 
   * <b>extra transition</b>. Uses assertFalse() since we expect 
   * AutomationProxy.equalsByContents() to return false in this case.
   */
   ...
   * rearranged so the structure is different. Uses assertFalse() since we 
   * expect AutomationProxy.equalsByContents() to return false in this case.
   */
   ...
   * directions are flipped. Uses assertFalse() since we expect 
   * AutomationProxy.equalsByContents() to return false in this case.
   */
   ...
   * different. Uses assertFalse() since we expect
   * AutomationProxy.equalsByContents() to return false in this case.
   */
  ...
  //#########################################################################
  //# Auxiliary Methods
  private void checkEqual(final String msg,
			  final AutomatonProxy aut1,
			  final AutomatonProxy aut2)
  {
    assertTrue(msg, aut1.equalsByContents(aut2));
    assertTrue(msg, aut2.equalsByContents(aut1));
  }

  private void checkNotEqual(final String msg,
			     final AutomatonProxy aut1,
			     final AutomatonProxy aut2)
  {
    assertFalse(msg, aut1.equalsByContents(aut2));
    assertFalse(msg, aut2.equalsByContents(aut1));
  }
  ...
  protected void setUp() throws Exception
  {
    ...
    List<StateProxy> states = new LinkedList<StateProxy>();
    // Initial state
    ...
    List<TransitionProxy> transitions = new LinkedList<TransitionProxy>();
