...
//# CLASS:   ThreePassCompilerTest
//###########################################################################
//# $Id: ThreePassCompilerTest.java,v 1.1 2008-06-19 21:26:59 robi Exp $
//###########################################################################
...
import net.sourceforge.waters.model.compiler.ThreePassCompiler;
...
public class ThreePassCompilerTest
  extends AbstractWatersTest
{
  ...
  private ProductDESProxy compile(final ModuleProxy module,
    ...
    throws EvalException
  {
    final ThreePassCompiler compiler =
      new ThreePassCompiler(mDocumentManager, mProductDESFactory, module);
