 ...
 * @author voronov
 */
public class ExprAcceptorCompareTest {
    ...
    private static void solveV(Expr e) throws TimeoutException{
        ...
        ExprAcceptor tc = new ExprAcceptorToCnfVar(ef, acceptor);        
        tc.accept(e);
        System.out.println(solver.isSatisfiable()?"V:SAT ":"V:UNsat ");
    }
    
    private static void compare(Expr e, ExprAcceptor tc1, ExprAcceptor tc2, ISolver solver) throws TimeoutException{
        solver.reset();
        tc1.accept(e);
